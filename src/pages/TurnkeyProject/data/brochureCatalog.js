...
const RAW = [
  ...
  ['cashew-nut-processing-plant/cashew-nut-brochure.png', 'cashew_nut_processing_plant.pdf', 'Cashew Nut Processing Plant', ['Complete turnkey solution for cashew nut processing from raw receiving to cleaned, graded and packaged kernels.', 'Automated cleaning, roasting, shelling, drying, peeling, grading and packaging in a hygienic food-grade line.'], '/turnkey-project/cashew-nut-processing-plant'],
  ['industry-4-automation-food-plant/industry-4-brochure.png', 'industry_4_automation_food_plant.pdf', 'Industry 4.0 Automation for Food Plant', ['Complete Industry 4.0 automation solutions for food processing plants including PLC/SCADA, IoT, robotics, vision inspection and smart packaging.', 'Real-time process monitoring, predictive maintenance, digital traceability and data analytics to maximise OEE and food safety compliance.'], '/turnkey-project/industry-4-automation-food-plant'],
  ['roasted-nuts-snacks-making-plant/roasted-nuts-brochure.png', 'roasted_nuts_snacks_making_plant.pdf', 'ROASTED NUTS SNACKS MAKING PLANT', ['Fluid-bed or drum roasting with seasoning drums and nitrogen-flushed packing.', 'Maintains crunch while limiting oil migration during high-speed retail transitions.'], '/turnkey-project/roasted-nuts-snacks-making-plant'],

  ['groundnut-chikki-processing-plant/groundnut-chikki-brochure.png', 'groundnut_chikki_processing_plant.pdf', 'Groundnut Chikki Processing Plant', ['Complete turnkey solution for groundnut chikki processing and packaging.', 'From raw groundnut cleaning and roasting to jaggery mixing, slab forming, cutting and packaging.'], '/turnkey-project/groundnut-chikki-processing-plant'],
  ['fruit-powder-processing-plant/fruit-powder-brochure.jpg', 'fruit_powder_processing_plant.pdf', 'Fruit Powder Processing Plant', ['Complete turnkey solution for fruit powder processing and packaging.', 'Advanced drying, milling and blending systems for high-quality fruit powders.'], '/turnkey-project/fruit-powder-processing-plant'],
