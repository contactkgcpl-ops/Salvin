...
const RAW = [
  ...
  ['12_blank_pepper_powder.png', 'salvin food powder processing machinaries.pdf', 'Black Pepper Powder Line', ['Cryogenic or ambient milling with sieving integrated ahead of bulk packing.', 'Protects volatile oils while controlling particle size bands for institutional buyers.']],
  ...
  ['14_cocoa_powder_making_machine.png', 'instant_coffee_processing.pdf', 'Cocoa Powder Processing System', ['Pressing, alkalising paths optional, and micronising rooms isolated for allergens.', 'Supports confectionery ingredient specs with traceable mass balance reporting.']],
