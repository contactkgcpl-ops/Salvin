...
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Jaggery Processing Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Jaggery Processing Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
      ...
      <section className="opp-hero">
        ...
        <div className="opp-hero__content">
          ...
          <p className="opp-hero__subtitle">
            Start Your Own Jaggery Processing Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
        ...
        <div className={`opp-container opp-animate ${isVisible['overview'] ? 'opp-animate--in' : ''}`}>
          ...
          <div className="opp-overview__grid">
            <div className="opp-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Jaggery Processing Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
          ...
          <div className={`opp-container opp-animate ${isVisible['seo-guide'] ? 'opp-animate--in' : ''}`}>
            ...
            <div className="opp-seo-content__body">
              <div className="opp-seo-content__block">
                ...
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Jaggery Processing Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
