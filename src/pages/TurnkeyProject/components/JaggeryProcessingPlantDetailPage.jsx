...
/* ─── Process Flow Steps ─── */
const PROCESS_STEPS = [
  { id: 1, title: 'Sugar Cane Reception' },
  { id: 2, title: 'Juice Extraction' },
  { id: 3, title: 'Clarification' },
  { id: 4, title: 'Concentration' },
  { id: 5, title: 'Crystallization' },
  { id: 6, title: 'Moulding' },
...
const MACHINERY_LIST = [
  {
    ...
    desc: 'Heavy-duty multi-roller cane crusher engineered to extract maximum juice from sugarcane.'
  },
  {
    name: 'Juice Filtration System',
    image: '/turnkey-brochures/images/jaggery-plant/2_juice_filtration.webp',
    desc: 'Multi-stage clarification and filtration unit to remove impurities and produce crystal-clear juice.'
  },
  {
    name: 'Evaporation System',
    image: '/turnkey-brochures/images/jaggery-plant/3_evaporation.webp',
    desc: 'Stainless-steel heating vessel for controlled juice concentration.'
  },
  {
    name: 'Jaggery Moulding Machine',
    image: '/turnkey-brochures/images/jaggery-plant/4_moulding_machine.webp',
    desc: 'Precision mould-filling machine producing uniform blocks and shapes of jaggery.'
  },
  {
    name: 'Cooling Conveyor',
    image: '/turnkey-brochures/images/jaggery-plant/5_cooling_conveyor.webp',
    desc: 'Automated cooling system that rapidly brings jaggery blocks to room temperature.'
  },
  {
    name: 'Packing Machine',
    image: '/turnkey-brochures/images/jaggery-plant/6_packing_machine.webp',
    desc: 'High-speed automated weighing and packaging machine for hygienic sealing of jaggery.'
  }
]
...
const FAQS = [
  {
    question: "What is the processing capacity of the Jaggery Processing Plant?",
  ...
  {
    question: "Can the plant produce different forms of jaggery?",
    answer: "Yes. The plant is designed to produce block jaggery, round jaggery, granular jaggery, and powder jaggery from the same processing line."
  },
  {
    question: "Is the plant fully automatic?",
    answer: "Yes. We offer semi-automatic and fully automatic solutions with advanced PLC control systems for efficient, low-labour operation."
  },
  {
  ...
  {
    question: "Why choose SALVIN for Jaggery Processing Plants?",
...
/* ════════════════════════════════════════════════════════════════════
   MAIN COMPONENT
   ════════════════════════════════════════════════════════════════════ */
export default function JaggeryProcessingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Jaggery Processing Plant | Turnkey Solutions | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey Jaggery Processing Plant by Salvin Industries. From sugarcane crushing to finished jaggery packaging — automated, food-grade, energy-efficient processing lines from 500 Kg/Hr to 10 Ton/Hr.')
  }, [])
    ...
    <div className="opp-page">
      ...
      <section className="opp-hero">
        ...
        <div className="opp-hero__content">
          <span className="opp-hero__badge">
            ...
            TURNKEY JAGGERY PROCESSING SOLUTION
          </span>
          <h1 className="opp-hero__title">
            Jaggery Processing Plant
          </h1>
          <p className="opp-hero__subtitle">
            Complete Turnkey Solution For Crushing, Clarification, Concentration, Moulding And Packaging Of Jaggery
          </p>
      ...
      <section className="opp-section opp-overview" id="overview" data-animate>
        <div className={`opp-container opp-animate ${isVisible['overview'] ? 'opp-animate--in' : ''}`}>
          ...
          <h2 className="opp-section-title">Complete Jaggery <span className="opp-accent">Processing Solution</span></h2>
          <div className="opp-overview__grid">
            <div className="opp-overview__text">
              <p>
                Salvin Industries' Jaggery Processing Plant is a turnkey industrial solution designed for processors who demand
                consistent quality, high throughput, and full regulatory compliance. Our integrated processing line handles every stage
                — from incoming sugarcane reception through final packaged jaggery — in a single, automated, hygienic facility.
              </p>
              <p>
                Each plant is custom-engineered to match your specific capacity requirements, product grades, and market standards.
                Whether you're producing retail packs, bulk institutional supply, or export-grade jaggery blocks and powder, our systems
                deliver the colour retention, natural aroma preservation, and food safety your buyers expect.
              </p>
              <div className="opp-overview__features">
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body">
                    <p className="opp-overview__feature-title">High Juice Yield</p>
                    <p className="opp-overview__feature-desc">Maximum juice recovery per tonne of cane</p>
                  </div>
                </div>
                <div className="opp-overview__feature">
                  <div className="opp-overview__feature-icon">
                ...
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body">
                    ...
                    <p className="opp-overview__feature-desc">Uniform colour, texture, and Brix output</p>
                  </div>
                </div>
                <div className="opp-overview__feature">
                  <div className="opp-overview__feature-icon">
                  ...
                  <div className="opp-overview__feature-body">
                    ...
                    <p className="opp-overview__feature-desc">Optimised steam and power consumption per ton</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="opp-section opp-process-new" id="process-flow" data-animate>
        <div className={`opp-container opp-animate ${isVisible['process-flow'] ? 'opp-animate--in' : ''}`}>
          ...
          <h2 className="opp-section-title">Jaggery <span className="opp-accent">Processing Workflow</span></h2>
          <p className="opp-section-subtitle">A streamlined and fully integrated processing workflow designed to transform raw sugarcane into premium-quality jaggery while ensuring maximum efficiency, product consistency and superior output quality.</p>
      ...
      <section className="opp-section opp-seo-content" id="seo-guide" data-animate>
        <div className={`opp-container opp-animate ${isVisible['seo-guide'] ? 'opp-animate--in' : ''}`}>
          ...
          <h2 className="opp-section-title">A Simple Guide to <span className="opp-accent">Jaggery Processing Plant</span></h2>
          ...
          <div className="opp-seo-content__body">
            <div className="opp-seo-content__block">
              <h3>Why Start a Jaggery Processing Plant Business?</h3>
              <p>The demand for high-quality, hygienically processed jaggery is growing rapidly in both domestic and international markets. Setting up an automated, high-capacity industrial plant ensures a highly profitable, recurring FMCG business with excellent ROI. Modern consumers prioritize branded, chemical-free products, making industrial automation the key to market success.</p>
            </div>
            <div className="opp-seo-content__block">
              <h3>How Does the Jaggery Processing Work?</h3>
              <p>The manufacturing process is a fully synchronized industrial workflow. It begins with automated intake of fresh sugarcane and thorough juice extraction. The raw juice is clarified to remove impurities, then concentrated under controlled heat to the right Brix level. Advanced thermal controls ensure natural colour and aroma are preserved. Finally, the mass is moulded into blocks or granulated and fed into high-speed packaging lines.</p>
            </div>
            <div className="opp-seo-content__block">
              <h3>The Salvin Industries Advantage</h3>
              <p>Salvin Industries provides end-to-end turnkey solutions for jaggery processing. Our machinery is constructed with premium SS304/SS316 food-grade stainless steel to meet global hygiene standards. Integrated with advanced PLC/SCADA control panels, our plants offer one-touch automation, reducing labour costs and eliminating human error. We handle everything—from factory layout design to machine manufacturing, installation, and global commissioning.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="opp-section opp-faq-section" id="faq" data-animate>
        <div className={`opp-container opp-animate ${isVisible['faq'] ? 'opp-animate--in' : ''}`}>
          ...
          <p className="opp-section-subtitle">Everything you need to know about our Jaggery Processing Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="JaggeryProcessingPlantDetailPage" />
      ...
      <section className="opp-section opp-cta" id="enquiry" data-animate>
        <div className={`opp-container opp-animate ${isVisible['enquiry'] ? 'opp-animate--in' : ''}`}>
          <div className="opp-cta__box">
            <h2>Ready to Build Your Jaggery Processing Plant?</h2>
            <p>
            ...
            <div className="opp-cta__actions">
              <a
                href="https://wa.me/919898727796?text=I%20am%20interested%20in%20the%20Jaggery%20Processing%20Plant.%20Please%20share%20details."
                target="_blank"
