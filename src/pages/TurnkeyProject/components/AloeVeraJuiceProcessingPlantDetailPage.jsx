...
export default function AloeVeraJuiceProcessingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automated Aloe Vera Juice Processing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automated Aloe Vera Juice Processing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
    ...
    <div className="rcp-page">
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Aloe Vera Juice Plant <span className="rcp-accent">Overview</span></h2>
      ...
      <section className="rcp-section rcp-process-new" id="process-flow" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['process-flow'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Aloe Vera Juice Production <span className="rcp-accent">Workflow</span></h2>
      ...
      <section className="rcp-section rcp-machinery" id="machinery" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['machinery'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Core Aloe Vera Juice <span className="rcp-accent">Equipment</span></h2>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Aloe Vera Juice Plant <span className="rcp-accent">FAQs</span></h2>
          <p className="rcp-section-subtitle">Everything you need to know about our Fully Automated Aloe Vera Juice Processing Plant.</p>
      ...
      <section className="rcp-section rcp-gallery" id="gallery" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['gallery'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Aloe Vera Juice Plant <span className="rcp-accent">Gallery</span></h2>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="AloeVeraJuiceProcessingPlantDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Aloe Vera Juice Plant?</h2>
            <p>
