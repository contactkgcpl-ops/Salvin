...
const PROCESS_STEPS = [
  ...
  { id: 2, title: "Extraction / Mixing" },
  { id: 3, title: "Filtration / Forming" },
  { id: 4, title: "Thermal Processing" },
  { id: 5, title: "Cooling" },
...
const MACHINERY_LIST = [
  {
    name: "Water Treatment & Multi-stage Filtration",
    desc: "Advanced water treatment system ensuring pure, demineralized water for high-quality surface cleaner production.",
    image: "/turnkey-brochures/images/surface-cleaner-gallery/1_water_treatment.png"
  },
  {
    name: "Rotary Bottle Filling & Capping Machine",
    desc: "High-speed rotary machine for precise volumetric filling and automatic capping of surface cleaner bottles.",
    image: "/turnkey-brochures/images/surface-cleaner-gallery/2_rotary_filling.png"
  },
  {
    name: "Automatic Inline Filling Machine",
    desc: "Efficient inline filling system equipped with multi-head nozzles for fast and accurate dispensing into containers.",
    image: "/turnkey-brochures/images/surface-cleaner-gallery/3_inline_filling.png"
  },
  {
    name: "Robotic Case Packaging & Palletizing",
    desc: "Fully automated robotic arm system for seamless case packing, sealing, and palletizing of finished products.",
    image: "/turnkey-brochures/images/surface-cleaner-gallery/4_case_packaging.png"
  },
  {
    name: "Skid-Mounted Stainless Steel Pipeline",
    desc: "Hygienic SS316 pipeline and filtration skid for transferring raw materials and finished product securely.",
    image: "/turnkey-brochures/images/surface-cleaner-gallery/5_filtration_skid.jpg"
  },
  {
    name: "Intermediate Storage & Mixing Tank",
    desc: "Jacketed stainless steel storage tank mounted on a robust frame for safe holding and uniform blending of the liquid.",
    image: "/turnkey-brochures/images/surface-cleaner-gallery/6_storage_tank.png"
  }
]
...
const FAQS = [
  {
    ...
    answer: "Our plants are highly customizable and can be designed for capacities ranging from small-scale artisanal production to large-scale industrial manufacturing, tailored to your specific requirements."
  },
  {
    question: "Is the plant fully automated?",
    answer: "Yes, the entire processing line is fully automated and controlled via advanced PLC/SCADA systems to ensure maximum efficiency, minimal human intervention, and consistent quality."
  },
  {
    question: "Do you provide installation and training?",
    answer: "Absolutely. Salvin Industries provides end-to-end turnkey solutions, which includes complete installation, commissioning, and comprehensive training for your operational staff."
  },
  {
    question: "What materials are used for the machinery?",
    answer: "All contact parts and critical structures are manufactured using premium SS304 or SS316 food-grade stainless steel to ensure the highest standards of hygiene and durability."
  }
];

/* ─── Gallery Images ─── */
const GALLERY_IMAGES = [
  { id: 1, src: '/turnkey-brochures/images/surface-cleaner-gallery/1_water_treatment.png', caption: 'Water Treatment & Multi-stage Filtration', alt: 'Water Treatment & Multi-stage Filtration' },
  { id: 2, src: '/turnkey-brochures/images/surface-cleaner-gallery/2_rotary_filling.png', caption: 'Rotary Bottle Filling & Capping Machine', alt: 'Rotary Bottle Filling & Capping Machine' },
  { id: 3, src: '/turnkey-brochures/images/surface-cleaner-gallery/3_inline_filling.png', caption: 'Automatic Inline Filling Machine', alt: 'Automatic Inline Filling Machine' },
  { id: 4, src: '/turnkey-brochures/images/surface-cleaner-gallery/4_case_packaging.png', caption: 'Robotic Case Packaging & Palletizing', alt: 'Robotic Case Packaging & Palletizing' },
  { id: 5, src: '/turnkey-brochures/images/surface-cleaner-gallery/5_filtration_skid.jpg', caption: 'Skid-Mounted Stainless Steel Pipeline', alt: 'Skid-Mounted Stainless Steel Pipeline' },
  { id: 6, src: '/turnkey-brochures/images/surface-cleaner-gallery/6_storage_tank.png', caption: 'Intermediate Storage & Mixing Tank', alt: 'Intermediate Storage & Mixing Tank' }
]

export default function SurfaceCleanerManufacturingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Surface Cleaner Manufacturing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Surface Cleaner Manufacturing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/cosmetic/surface_cleaner_hero.png')`, backgroundColor: '#333' }} />
        <div className="rcp-hero__content">
          ...
          <h1 className="rcp-hero__title">
            Surface Cleaner Manufacturing Plant
          </h1>
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Surface Cleaner <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Capitalize on the global market with our <strong>Surface Cleaner Manufacturing Plant</strong>. We deliver cutting-edge technology for processing Surface Cleaner, ensuring high yield and premium quality.</p>
              <p>The manufacturing process is meticulously designed to handle the specific requirements of Surface Cleaner production. From raw material intake to the final packaged product, every step is optimized for hygiene, speed, and consistency.</p>
            ...
            <div className="rcp-overview__image rcp-overview__image--photo">
              <img src="/turnkey-brochures/images/cosmetic/surface_cleaner_hero.png" alt="Plant Overview" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Surface Cleaner Manufacturing Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="SurfaceCleanerManufacturingPlantDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Surface Cleaner Plant?</h2>
            <p>
