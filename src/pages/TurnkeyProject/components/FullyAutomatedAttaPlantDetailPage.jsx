...
const FAQS = [
  {
    question: "What is the processing capacity of the Fully Automated Atta Plant?",
  ...
  {
    question: "Can the plant process different types of attaes?",
    answer: "Yes. The plant is designed to handle various atta varieties while maintaining product quality, color, and consistency."
  },
  {
  ...
  {
    question: "Why choose SALVIN for Fully Automated Atta Plants?",
      ...
      <section className="faap-hero">
        ...
        <div className="faap-hero__content">
          ...
          <p className="faap-hero__subtitle">
            Complete Turnkey Solution For Cleaning, Drying, Grinding, Pulverizing And Packaging Of Atta
          </p>
        ...
        <div className={`faap-container faap-animate ${isVisible['overview'] ? 'faap-animate--in' : ''}`}>
          ...
          <div className="faap-overview__grid">
            <div className="faap-overview__text">
              <p>
                Salvin Industries' Fully Automated Atta Plant is a turnkey industrial solution designed for processors who demand
                consistent quality, high throughput, and full regulatory compliance. Our integrated processing line handles every stage
                — from incoming raw atta inspection through final packaged product — in a single, automated, dust-free facility.
              </p>
              <p>
                Each plant is custom-engineered to match your specific capacity requirements, product grades, and market standards.
                Whether you're producing retail packs, bulk institutional supply, or export-grade atta powder, our systems deliver
      ...
      <section className="faap-section faap-process-new" id="process-flow" data-animate>
        ...
        <section className="faap-section faap-seo-content" id="seo-guide" data-animate>
          <div className={`faap-container faap-animate ${isVisible['seo-guide'] ? 'faap-animate--in' : ''}`}>
            <div className="faap-section-badge">COMPREHENSIVE GUIDE</div>
            <h2 className="faap-section-title">A Simple Guide to <span className="faap-accent">Fully Automated Atta Plant Processing</span></h2>
            <p className="faap-section-subtitle">Understanding the processing workflow, accuracy, and market impact.</p>
