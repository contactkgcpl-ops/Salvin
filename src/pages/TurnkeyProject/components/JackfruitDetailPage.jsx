...
export default function JackfruitDetailPage() {
  ...
  return (
    <div className="jcp-page">
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <section className="jcp-section jcp-why-salvin" id="why-salvin" data-animate>
        <div className={`jcp-container jcp-animate ${isVisible['why-salvin'] ? 'jcp-animate--in' : ''}`}>
          <div className="jcp-section-badge">Our Advantage</div>
          <h2 className="jcp-section-title">Why Choose <span className="jcp-accent">SALVIN</span></h2>
          <div className="jcp-why-salvin__grid">
            {/* Card 1 — Turnkey Solutions */}
            <div className="jcp-why-salvin__card">
              <div className="jcp-why-salvin__icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M2 20h20M4 20V10l8-7 8 7v10M10 20v-6h4v6" />
                </svg>
              </div>
              <div>
                <p className="jcp-why-salvin__title">Turnkey Solutions</p>
                <p className="jcp-why-salvin__desc">End-to-end processing solutions from design and manufacturing to installation and commissioning.</p>
              </div>
            </div>
            ...
            <div className="jcp-why-salvin__card">
              ...
              <div>
                <p className="jcp-why-salvin__title">Food Grade Design</p>
                <p className="jcp-why-salvin__desc">SS304/SS316 contact parts with hygienic construction for food-safe processing.</p>
              </div>
            </div>
            ...
            <div className="jcp-why-salvin__card">
              ...
              <div>
                <p className="jcp-why-salvin__title">Energy Efficient</p>
                <p className="jcp-why-salvin__desc">Optimized systems designed to reduce power consumption and improve productivity.</p>
              </div>
            </div>
            ...
            <div className="jcp-why-salvin__card">
              ...
              <div>
                <p className="jcp-why-salvin__title">Low Maintenance</p>
                <p className="jcp-why-salvin__desc">Robust industrial construction ensuring long service life and minimal maintenance.</p>
              </div>
            </div>
            ...
            <div className="jcp-why-salvin__card">
              ...
              <div>
                <p className="jcp-why-salvin__title">Automation Ready</p>
                <p className="jcp-why-salvin__desc">PLC-based automation and intelligent controls for consistent production.</p>
              </div>
            </div>
            ...
            <div className="jcp-why-salvin__card">
              ...
              <div>
                <p className="jcp-why-salvin__title">After Sales Support</p>
                <p className="jcp-why-salvin__desc">Dedicated technical support, spare parts assistance and service guidance.</p>
              </div>
            </div>
          </div>
        </div>
