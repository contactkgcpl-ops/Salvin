...
const MACHINERY_LIST = [

  {
    ...
    "image": "/assets/plants/beverages/energy-drink-gallery/1.webp"
  },
  {
    "name": "Mixing & Batch Preparation",
    "desc": "Blends ingredients accurately for consistent energy drink batches.",
    "image": "/assets/plants/beverages/energy-drink-gallery/2.webp"
  },
  {
    "name": "Homogenization & Carbonation Unit",
    "desc": "Ensures uniform texture, removes air, and injects CO2.",
    "image": "/assets/plants/beverages/energy-drink-gallery/3.webp"
  },
  {
    "name": "Auto Filling & Seaming Machine",
    "desc": "High-speed filling and seaming for cans or bottles.",
    "image": "/assets/plants/beverages/energy-drink-gallery/4.webp"
  },
  {
    "name": "Sleeve Labeling & Shrink Tunnel",
    "desc": "Automatically applies wrap-around labels or shrink sleeves.",
    "image": "/assets/plants/beverages/energy-drink-gallery/5.webp"
  },
  {
    "name": "Carton Packing & Robotic Palletizer",
    "desc": "Automated packing into cartons and robotic palletizing.",
    "image": "/assets/plants/beverages/energy-drink-gallery/6.webp"
  }
]
/* â”€â”€â”€ FAQs â”€â”€â”€ */
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Fully Automated Energy Drink Processing Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Fully Automated Energy Drink Processing Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
...
const GALLERY_IMAGES = [
  {
    "src": "/assets/plants/beverages/energy-drink-gallery/1.webp",
    "caption": "Water Treatment & Ingredient Preparation System"
  },
  {
    "src": "/assets/plants/beverages/energy-drink-gallery/2.webp",
    "caption": "Energy Drink Mixing & Batch Preparation Tank"
  },
  {
    "src": "/assets/plants/beverages/energy-drink-gallery/3.webp",
    "caption": "Homogenization, Deaeration & Carbonation Unit"
  },
  {
    "src": "/assets/plants/beverages/energy-drink-gallery/4.webp",
    "caption": "Automatic Filling & Seaming Machine"
  },
  {
    "src": "/assets/plants/beverages/energy-drink-gallery/5.webp",
    "caption": "Sleeve Labeling Machine & Shrink Tunnel"
  },
  {
    "src": "/assets/plants/beverages/energy-drink-gallery/6.webp",
    "caption": "Carton Packing Machine & Robotic Palletizer"
  }
]

export default function EnergyDrinkProcessingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automated Energy Drink Processing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automated Energy Drink Processing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/plants/beverages/beverage-heroes/hero_energy_drink.webp')` }} />
        <div className="rcp-hero__content">
          ...
          <h1 className="rcp-hero__title">
            Fully Automated Energy Drink Processing Plant
          </h1>
          <p className="rcp-hero__subtitle">
            Start Your Own Fully Automated Energy Drink Processing Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Energy Drink <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Fully Automated Energy Drink Processing Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Energy Drink Processing Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Energy Drink Plant?</h2>
            <p>
          ...
          <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
            ...
            <div className="rcp-seo-content__body">
              <div className="rcp-seo-content__block">
                <h3>Why Start a Fully Automated Energy Drink Processing Plant Business?</h3>
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Fully Automated Energy Drink Processing Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
