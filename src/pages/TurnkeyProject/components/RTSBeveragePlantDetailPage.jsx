...
const MACHINERY_LIST = [

  {
    ...
    "image": "/assets/plants/beverages/rts-beverage-gallery/1.webp"
  },
  {
    "name": "Sugar Syrup & Beverage Blending",
    "desc": "High-capacity tanks for preparing syrup and blending flavors.",
    "image": "/assets/plants/beverages/rts-beverage-gallery/2.webp"
  },
  {
    "name": "Homogenization & Pasteurization",
    "desc": "Ensures uniform texture and eliminates microbes for safety.",
    "image": "/assets/plants/beverages/rts-beverage-gallery/3.webp"
  },
  {
    "name": "Cooling & Beverage Storage",
    "desc": "Plate heat exchangers and chilled tanks for storing beverages.",
    "image": "/assets/plants/beverages/rts-beverage-gallery/4.webp"
  },
  {
    "name": "Automatic Filling & Sealing",
    "desc": "High-speed hygienic filling and capping machines for bottles.",
    "image": "/assets/plants/beverages/rts-beverage-gallery/5.webp"
  },
  {
    "name": "Labeling & Carton Packaging",
    "desc": "End-of-line labeling, shrink wrapping, and carton packing.",
    "image": "/assets/plants/beverages/rts-beverage-gallery/6.webp"
  }
]
/* â”€â”€â”€ FAQs â”€â”€â”€ */
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Fully Automated RTS Beverage Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Fully Automated RTS Beverage Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
...
const GALLERY_IMAGES = [
  {
    "src": "/assets/plants/beverages/rts-beverage-gallery/1.webp",
    "caption": "Water Treatment & Ingredient Mixing System"
  },
  {
    "src": "/assets/plants/beverages/rts-beverage-gallery/2.webp",
    "caption": "Sugar Syrup Preparation & Beverage Blending Tank"
  },
  {
    "src": "/assets/plants/beverages/rts-beverage-gallery/3.webp",
    "caption": "Homogenizer, Deaerator & Pasteurization Unit"
  },
  {
    "src": "/assets/plants/beverages/rts-beverage-gallery/4.webp",
    "caption": "Plate Heat Exchanger & Beverage Cooling Tank"
  },
  {
    "src": "/assets/plants/beverages/rts-beverage-gallery/5.webp",
    "caption": "Automatic Bottle Filling & Sealing Machine"
  },
  {
    "src": "/assets/plants/beverages/rts-beverage-gallery/6.webp",
    "caption": "Labeling, Shrink Wrapping & Carton Packing"
  }
]

export default function RTSBeveragePlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automated RTS Beverage Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automated RTS Beverage Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/plants/beverages/beverage-heroes/hero_rts_beverage.webp')` }} />
        <div className="rcp-hero__content">
          ...
          <h1 className="rcp-hero__title">
            Fully Automated RTS Beverage Plant
          </h1>
          <p className="rcp-hero__subtitle">
            Start Your Own Fully Automated RTS Beverage Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial RTS Beverage <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Fully Automated RTS Beverage Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our RTS Beverage Processing Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your RTS Beverage Plant?</h2>
            <p>
          ...
          <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
            ...
            <div className="rcp-seo-content__body">
              <div className="rcp-seo-content__block">
                <h3>Why Start a Fully Automated RTS Beverage Plant Business?</h3>
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Fully Automated RTS Beverage Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
