        ...
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Launch your own brand of delicious fruit drinks with our <strong>Fully Automated RTS (Ready-To-Serve) Beverage Plant</strong>. Mango drinks, guava juices, and mixed fruit beverages are immensely popular and form a massive segment of the beverage industry.</p>
