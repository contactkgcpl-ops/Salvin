...
/* ─── Process Flow Steps ─── */
const PROCESS_STEPS = [
  { id: 1, title: 'Raw Sugar Reception' },
  { id: 2, title: 'Dissolution' },
  { id: 3, title: 'Filtration' },
  { id: 4, title: 'Decolourisation' },
  { id: 5, title: 'Concentration' },
  { id: 6, title: 'Flavouring' },
  { id: 7, title: 'Filling & Packaging' },
]
...
export default function SugarSyrupPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Sugar Syrup Plant | Turnkey Solutions | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey Sugar Syrup Plant by Salvin Industries. From raw sugar dissolution to finished syrup filling — automated, food-grade, energy-efficient processing lines from 500 LPH to 20,000 LPH.')
  }, [])
    ...
    <div className="opp-page">
      ...
      <section className="opp-section opp-overview" id="overview" data-animate>
        <div className={`opp-container opp-animate ${isVisible['overview'] ? 'opp-animate--in' : ''}`}>
          ...
          <h2 className="opp-section-title">Complete Sugar Syrup <span className="opp-accent">Processing Solution</span></h2>
              ...
              <div className="opp-overview__features">
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body">
                    ...
                    <p className="opp-overview__feature-desc">Maximum sugar recovery per batch</p>
                  </div>
                </div>
                <div className="opp-overview__feature">
                  <div className="opp-overview__feature-icon">
                ...
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body">
                    ...
                    <p className="opp-overview__feature-desc">Uniform Brix and colour output</p>
                  </div>
                </div>
                <div className="opp-overview__feature">
                  <div className="opp-overview__feature-icon">
                  ...
                  <div className="opp-overview__feature-body">
                    ...
                    <p className="opp-overview__feature-desc">Optimised steam and power consumption</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="opp-section opp-process-new" id="process-flow" data-animate>
        <div className={`opp-container opp-animate ${isVisible['process-flow'] ? 'opp-animate--in' : ''}`}>
          ...
          <h2 className="opp-section-title">Sugar Syrup <span className="opp-accent">Processing Workflow</span></h2>
          <p className="opp-section-subtitle">A streamlined and fully integrated processing workflow designed to transform raw sugar into premium-quality syrup while ensuring maximum efficiency, product consistency and superior output quality.</p>
      ...
      <section className="opp-section opp-faq-section" id="faq" data-animate>
        <div className={`opp-container opp-animate ${isVisible['faq'] ? 'opp-animate--in' : ''}`}>
          ...
          <p className="opp-section-subtitle">Everything you need to know about our Sugar Syrup Plant.</p>
              ...
              return (
                <div key={index} className={`opp-faq__item ${isOpen ? 'opp-faq__item--open' : ''}`}>
                  ...
                  <div className="opp-faq__answer-wrapper">
                    <div className="opp-faq__answer-content"><p>{faq.answer}</p></div>
                  </div>
                </div>
              );
            })}
      ...
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="SugarSyrupPlantDetailPage" />
      ...
      <section className="opp-section opp-cta" id="enquiry" data-animate>
        <div className={`opp-container opp-animate ${isVisible['enquiry'] ? 'opp-animate--in' : ''}`}>
          <div className="opp-cta__box">
            <h2>Ready to Build Your Sugar Syrup Plant?</h2>
            ...
            <div className="opp-cta__actions">
              <a href="https://wa.me/919898727796?text=I%20am%20interested%20in%20the%20Sugar%20Syrup%20Plant.%20Please%20share%20details." target="_blank" rel="noopener noreferrer" className="opp-btn opp-btn--primary opp-btn--lg">
