...
const PROCESS_STEPS = [
  { id: 1, title: 'Bean Reception' },
  { id: 2, title: 'Cleaning & Sorting' },
  { id: 3, title: 'Roasting' },
  { id: 4, title: 'Winnowing' },
  { id: 5, title: 'Grinding & Pressing' },
  { id: 6, title: 'Pulverising' },
...
export default function CocoaPowderPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Cocoa Powder Processing Plant | Turnkey Solutions | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey Cocoa Powder Processing Plant by Salvin Industries. From cocoa bean roasting to finished powder packaging — automated, food-grade, energy-efficient processing lines from 200 Kg/Hr to 3 Ton/Hr.')
  }, [])
  useEffect(() => {
    ...
    <div className="opp-page">
            ...
            <div className="opp-overview__text">
              ...
              <div className="opp-overview__features">
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body"><p className="opp-overview__feature-title">High Yield</p><p className="opp-overview__feature-desc">Maximum cocoa butter extraction per press cycle</p></div>
                </div>
                <div className="opp-overview__feature">
                ...
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body"><p className="opp-overview__feature-title">Consistent Quality</p><p className="opp-overview__feature-desc">Uniform colour, pH, and fat content</p></div>
                </div>
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body"><p className="opp-overview__feature-title">Energy Efficient</p><p className="opp-overview__feature-desc">Optimised power and thermal consumption per ton</p></div>
                </div>
              </div>
            </div>
      ...
      <section className="opp-section opp-process-new" id="process-flow" data-animate>
        <div className={`opp-container opp-animate ${isVisible['process-flow'] ? 'opp-animate--in' : ''}`}>
          ...
          <h2 className="opp-section-title">Cocoa Powder <span className="opp-accent">Processing Workflow</span></h2>
          <p className="opp-section-subtitle">A streamlined and fully integrated processing workflow designed to transform raw cocoa beans into premium-quality cocoa powder while ensuring maximum efficiency, product consistency and superior output quality.</p>
      ...
      <section className="opp-section opp-faq-section" id="faq" data-animate>
        <div className={`opp-container opp-animate ${isVisible['faq'] ? 'opp-animate--in' : ''}`}>
          ...
          <p className="opp-section-subtitle">Everything you need to know about our Cocoa Powder Processing Plant.</p>
      ...
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="CocoaPowderPlantDetailPage" />
      ...
      <section className="opp-section opp-cta" id="enquiry" data-animate>
        <div className={`opp-container opp-animate ${isVisible['enquiry'] ? 'opp-animate--in' : ''}`}>
          <div className="opp-cta__box">
            <h2>Ready to Build Your Cocoa Powder Processing Plant?</h2>
            ...
            <div className="opp-cta__actions">
              <a href="https://wa.me/919898727796?text=I%20am%20interested%20in%20the%20Cocoa%20Powder%20Processing%20Plant.%20Please%20share%20details." target="_blank" rel="noopener noreferrer" className="opp-btn opp-btn--primary opp-btn--lg">
