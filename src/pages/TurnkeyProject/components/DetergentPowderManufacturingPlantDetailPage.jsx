...
const MACHINERY_LIST = [
  {
    name: "Raw Material Silos & Dosing System",
    desc: "Large capacity stainless steel silos equipped with automated weighing and dosing systems for precise ingredient handling.",
    image: "/turnkey-brochures/images/detergent-powder-gallery/1_silos.jpg"
  },
  {
    name: "Vibro Sifter / Circular Separator",
    desc: "High-efficiency vibro sifter for screening, grading, and separating powder lumps to ensure uniform particle size.",
    image: "/turnkey-brochures/images/detergent-powder-gallery/2_vibro_sifter.png"
  },
  {
    name: "Heavy Duty Ribbon Blender",
    desc: "Robust ribbon blender with a heavy-duty motor designed for thorough and homogeneous mixing of detergent powders.",
    image: "/turnkey-brochures/images/detergent-powder-gallery/3_ribbon_blender_grey.png"
  },
  {
    name: "Stainless Steel Ribbon Blender",
    desc: "Premium SS304/SS316 ribbon blender ensuring high hygiene standards and resistance to chemical corrosion.",
    image: "/turnkey-brochures/images/detergent-powder-gallery/4_ribbon_blender_ss.jpg"
  },
  {
    name: "Elevated Ribbon Mixing System",
    desc: "Elevated ribbon blender mounted on a sturdy frame to facilitate gravity-fed discharge into downstream packaging equipment.",
    image: "/turnkey-brochures/images/detergent-powder-gallery/5_ribbon_blender_frame.png"
  },
  {
    name: "Automatic Rotary Capping Machine",
    desc: "High-speed automated rotary capping machine for secure and reliable sealing of packaged detergent containers.",
    image: "/turnkey-brochures/images/detergent-powder-gallery/6_capping_machine.png"
  }
]
...
const GALLERY_IMAGES = [
  { id: 1, src: '/turnkey-brochures/images/detergent-powder-gallery/1_silos.jpg', caption: 'Raw Material Silos & Dosing System', alt: 'Raw Material Silos & Dosing System' },
  { id: 2, src: '/turnkey-brochures/images/detergent-powder-gallery/2_vibro_sifter.png', caption: 'Vibro Sifter / Circular Separator', alt: 'Vibro Sifter / Circular Separator' },
  { id: 3, src: '/turnkey-brochures/images/detergent-powder-gallery/3_ribbon_blender_grey.png', caption: 'Heavy Duty Ribbon Blender', alt: 'Heavy Duty Ribbon Blender' },
  { id: 4, src: '/turnkey-brochures/images/detergent-powder-gallery/4_ribbon_blender_ss.jpg', caption: 'Stainless Steel Ribbon Blender', alt: 'Stainless Steel Ribbon Blender' },
  { id: 5, src: '/turnkey-brochures/images/detergent-powder-gallery/5_ribbon_blender_frame.png', caption: 'Elevated Ribbon Mixing System', alt: 'Elevated Ribbon Mixing System' },
  { id: 6, src: '/turnkey-brochures/images/detergent-powder-gallery/6_capping_machine.png', caption: 'Automatic Rotary Capping Machine', alt: 'Automatic Rotary Capping Machine' }
]

export default function DetergentPowderManufacturingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Detergent Powder Manufacturing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Detergent Powder Manufacturing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/cosmetic/detergent_powder_hero.png')`, backgroundColor: '#333' }} />
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Detergent Powder <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Capitalize on the global market with our <strong>Detergent Powder Manufacturing Plant</strong>. We deliver cutting-edge technology for processing Detergent Powder, ensuring high yield and premium quality.</p>
              <p>The manufacturing process is meticulously designed to handle the specific requirements of Detergent Powder production. From raw material intake to the final packaged product, every step is optimized for hygiene, speed, and consistency.</p>
            ...
            <div className="rcp-overview__image rcp-overview__image--photo">
              <img src="/turnkey-brochures/images/cosmetic/detergent_powder_hero.png" alt="Plant Overview" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Detergent Powder Manufacturing Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="DetergentPowderManufacturingPlantDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Detergent Powder Plant?</h2>
            <p>
      ...
      <section className="rcp-section rcp-seo-content" id="seo-guide" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">A Simple Guide to <span className="rcp-accent">Detergent Powder Processing</span></h2>
          <p className="rcp-section-subtitle">Understanding the processing workflow, accuracy, and market impact.</p>
          <div className="rcp-seo-content__body">
            <div className="rcp-seo-content__block">
              <h3>Why Start a Detergent Powder Processing Business?</h3>
              <p>The demand for high-quality, hygienically processed Detergent Powder is growing rapidly in both domestic and international markets. Setting up an automated, high-capacity industrial plant ensures a highly profitable, recurring FMCG business with excellent ROI. Modern consumers prioritize branded, untouched-by-hand products, making industrial automation the key to market success.</p>
            </div>
            
            <div className="rcp-seo-content__block">
              <h3>How Does the Detergent Powder Processing Work?</h3>
