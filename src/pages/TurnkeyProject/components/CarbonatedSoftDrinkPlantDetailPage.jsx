...
export default function CarbonatedSoftDrinkPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automatic Carbonated Soft Drink Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automatic Carbonated Soft Drink Plant. High efficiency, robust design, and automatic processing.')
  }, [])
    ...
    <div className="rcp-page">
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Carbonated Soft Drink Processing Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Carbonated Soft Drink Plant?</h2>
            <p>
