...
const MACHINERY_LIST = [

  {
    ...
    image: '/turnkey-brochures/images/body-butter-gallery/1_weighing_dosing.png',
    desc: 'Salvin Industries builds this automatic system. It handles the initial processing stage with high efficiency before moving to the next machine.'
  },
  {
    name: 'Syrup Preparation System',
    image: '/turnkey-brochures/images/body-butter-gallery/2_vacuum_mixer.jpg',
    desc: 'Our heavy-duty machine is designed for maximum yield and perfect product quality automatically.'
  },
  {
    name: 'Body Butter Mass Mixer',
    image: '/turnkey-brochures/images/body-butter-gallery/3_high_shear.png',
    desc: 'This machine processes your product smoothly. It makes sure the final output is completely consistent without any human touch.'
  },
  {
    name: 'Body Butter Forming Machine',
    image: '/turnkey-brochures/images/body-butter-gallery/4_storage_tank.png',
    desc: 'We manufacture this machine to handle the core processing. It works continuously while keeping the natural taste and quality safe.'
  },
  {
    name: 'Body Butter Cutting Machine',
    image: '/turnkey-brochures/images/body-butter-gallery/5_filling_capping.png',
    desc: 'This is a very important machine in the line. It ensures your product is processed hygienically for a long shelf life.'
  },
  {
    name: 'Flow Wrapping & Packaging Machine',
    image: '/turnkey-brochures/images/body-butter-gallery/6_labeling_packing.png',
...
const GALLERY_IMAGES = [
  { src: '/turnkey-brochures/images/body-butter-gallery/1_weighing_dosing.png', caption: 'Ingredient Dosing & Mixing System' },
  { src: '/turnkey-brochures/images/body-butter-gallery/2_vacuum_mixer.jpg', caption: 'Syrup Preparation System' },
  { src: '/turnkey-brochures/images/body-butter-gallery/3_high_shear.png', caption: 'Body Butter Mass Mixer' },
  { src: '/turnkey-brochures/images/body-butter-gallery/4_storage_tank.png', caption: 'Body Butter Forming Machine' },
  { src: '/turnkey-brochures/images/body-butter-gallery/5_filling_capping.png', caption: 'Body Butter Cutting Machine' },
  { src: '/turnkey-brochures/images/body-butter-gallery/6_labeling_packing.png', caption: 'Flow Wrapping Machine' },
]
        ...
        <div className={`bbm-container ${isVisible['overview'] ? 'bbm-animate--in' : ''}`}>
          ...
          <div className="bbm-overview__grid">
            ...
            <div className="bbm-overview__image bbm-overview__image--photo" style={{ backgroundColor: '#fff', padding: '10px', display: 'flex', justifyContent: 'center' }}>
              <img src={'/turnkey-brochures/images/body-butter-gallery/2_vacuum_mixer.jpg'} alt="Plant Overview" loading="lazy" style={{ objectFit: 'contain', width: '100%', height: '100%', maxHeight: '600px', borderRadius: '8px' }} />
            </div>
          </div>
        </div>
      </section>
