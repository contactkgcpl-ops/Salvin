...
const MACHINERY_LIST = [

  {
    ...
    "image": "/assets/plants/food/frozen-veg-gallery/veg_washing.webp",
  ...
  },
  {
    ...
    "image": "/assets/plants/food/frozen-veg-gallery/veg_slicing.webp",
  ...
  },
  {
    ...
    "image": "/assets/plants/food/frozen-veg-gallery/continuous_blancher.webp",
  ...
  },
  {
    ...
    "image": "/assets/plants/food/frozen-veg-gallery/iqf_freezer.webp",
  ...
  },
  {
    ...
    "image": "/assets/plants/food/frozen-veg-gallery/veg_packaging.webp",
  ...
  },
  {
    ...
    "image": "/assets/plants/food/frozen-veg-gallery/cold_storage.webp",
...
const GALLERY_IMAGES = [
  { src: "/assets/plants/food/frozen-veg-gallery/veg_washing.webp", caption: "High-Capacity Vegetable Washing System" },
  { src: "/assets/plants/food/frozen-veg-gallery/veg_slicing.webp", caption: "Automatic Cutting & Slicing Machine" },
  { src: "/assets/plants/food/frozen-veg-gallery/continuous_blancher.webp", caption: "Continuous Blanching System" },
  { src: "/assets/plants/food/frozen-veg-gallery/iqf_freezer.webp", caption: "IQF (Individual Quick Freezing) Tunnel" },
  { src: "/assets/plants/food/frozen-veg-gallery/veg_packaging.webp", caption: "Multihead Weigher & VFFS Packaging Machine" },
  { src: "/assets/plants/food/frozen-veg-gallery/cold_storage.webp", caption: "Robotic Palletizing & Cold Storage System (-18°C)" }
];
...
export default function FullyAutomatedFrozenVegetableProcessingPlantDetailPage() {
  ...
  return (
    <div className="rcp-page">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: "url('/assets/plants/food/hero_frozen_veg.webp')" }} />
        ...
        <div className={`rcp-container rcp-animate ${isVisible["overview"] ? "rcp-animate--in" : ""}`}>
          ...
          <div className="rcp-overview__grid">
            ...
            <div className="rcp-overview__image rcp-overview__image--photo">
              <img src="/assets/plants/food/frozen-veg-gallery/iqf_freezer.webp" alt="Fully Automated Frozen Vegetable Processing Plant Overview" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="rcp-back-nav">
        ...
        <section className="rcp-section rcp-seo-content" id="seo-guide" data-animate>
          <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
            ...
            <h2 className="rcp-section-title">A Simple Guide to <span className="rcp-accent">Fully Automated Frozen Vegetable Processing Plant Processing</span></h2>
            <p className="rcp-section-subtitle">Understanding the processing workflow, accuracy, and market impact.</p>
            <div className="rcp-seo-content__body">
              <div className="rcp-seo-content__block">
                <h3>Why Start a Fully Automated Frozen Vegetable Processing Plant Business?</h3>
                <p>The demand for high-quality, hygienically processed Fully Automated Frozen Vegetable Processing Plant is growing rapidly in both domestic and international markets. Setting up an automated, high-capacity industrial plant ensures a highly profitable, recurring FMCG business with excellent ROI. Modern consumers prioritize branded, untouched-by-hand products, making industrial automation the key to market success.</p>
              </div>
              
              <div className="rcp-seo-content__block">
                <h3>How Does the Fully Automated Frozen Vegetable Processing Plant Processing Work?</h3>
