...
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Complete Potato Powder Dehydration Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Complete Potato Powder Dehydration Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
  ...
  return (
    <div className="ppd-page">
      ...
      <section className="ppd-hero">
        ...
        <div className="ppd-hero__content">
          ...
          <p className="ppd-hero__subtitle">
            Start Your Own Complete Potato Powder Dehydration Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
        ...
        <div className={`ppd-container ppd-animate ${isVisible['overview'] ? 'ppd-animate--in' : ''}`}>
          ...
          <div className="ppd-overview__grid">
            <div className="ppd-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Complete Potato Powder Dehydration Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
      ...
      <section className="ppd-section ppd-process-new" id="process-flow" data-animate>
        ...
        <section className="ppd-section ppd-seo-content" id="seo-guide" data-animate>
          <div className={`ppd-container ppd-animate ${isVisible['seo-guide'] ? 'ppd-animate--in' : ''}`}>
            <div className="ppd-section-badge">ABOUT THE PLANT</div>
            <h2 className="ppd-section-title">How Does The <span className="ppd-accent">Plant Work?</span></h2>
            <p className="ppd-section-subtitle">A simple explanation of the machinery and process by Salvin Industries.</p>
            <div className="ppd-seo-content__body">
              <div className="ppd-seo-content__block">
                <h3>Why Start a Complete Potato Powder Dehydration Plant Business?</h3>
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Complete Potato Powder Dehydration Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
