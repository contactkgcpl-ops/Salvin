...
const MACHINERY_LIST = [

  {
    ...
    "image": "/assets/plants/dairy/buttermilk-gallery/1.webp"
  },
  {
    "name": "Cream Separator Unit",
    "desc": "Precision separation and preparation of buttermilk.",
    "image": "/assets/plants/dairy/buttermilk-gallery/2.webp"
  },
  {
    "name": "Pasteurization & Homogenization",
    "desc": "Ensures uniform texture and thermal processing.",
    "image": "/assets/plants/dairy/buttermilk-gallery/3.webp"
  },
  {
    "name": "Mixing & Flavoring Tank",
    "desc": "Automated mixing of buttermilk and spices/flavors.",
    "image": "/assets/plants/dairy/buttermilk-gallery/4.webp"
  },
  {
    "name": "Automatic Pouch Packing Line",
    "desc": "High-speed filling and packaging of buttermilk.",
    "image": "/assets/plants/dairy/buttermilk-gallery/5.webp"
  },
  {
    "name": "Cold Storage & Dispatch",
    "desc": "Temperature-controlled storage for final dispatch.",
    "image": "/assets/plants/dairy/buttermilk-gallery/6.webp"
  }
]
/* ─── FAQs ─── */
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Fully Automated Buttermilk Processing Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Fully Automated Buttermilk Processing Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
...
const GALLERY_IMAGES = [
  {
    "src": "/assets/plants/dairy/buttermilk-gallery/1.webp",
    "caption": "Raw Milk Reception & Filtration"
  },
  {
    "src": "/assets/plants/dairy/buttermilk-gallery/2.webp",
    "caption": "Cream Separator Unit"
  },
  {
    "src": "/assets/plants/dairy/buttermilk-gallery/3.webp",
    "caption": "Pasteurization & Homogenization System"
  },
  {
    "src": "/assets/plants/dairy/buttermilk-gallery/4.webp",
    "caption": "Buttermilk Mixing & Flavoring Tank"
  },
  {
    "src": "/assets/plants/dairy/buttermilk-gallery/5.webp",
    "caption": "Automatic Pouch Packing Line"
  },
  {
    "src": "/assets/plants/dairy/buttermilk-gallery/6.webp",
    "caption": "Cold Storage & Dispatch Area"
  }
]

export default function ButtermilkProcessingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automated Buttermilk Processing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automated Buttermilk Processing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/core/heroes/dairy-heroes/buttermilk.webp')` }} />
        <div className="rcp-hero__content">
          ...
          <h1 className="rcp-hero__title">
            Fully Automated Buttermilk Processing Plant
          </h1>
          <p className="rcp-hero__subtitle">
            Start Your Own Fully Automated Buttermilk Processing Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Buttermilk <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Fully Automated Buttermilk Processing Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
          ...
          <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
            ...
            <div className="rcp-seo-content__body">
              <div className="rcp-seo-content__block">
                <h3>Why Start a Fully Automated Buttermilk Processing Plant Business?</h3>
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Fully Automated Buttermilk Processing Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Buttermilk Processing Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Buttermilk Plant?</h2>
            <p>
