...
const MACHINERY_LIST = [
  {
    ...
    image: "/turnkey-brochures/images/cosmetic/hand_wash_plant_1.webp"
  },
  {
    ...
    image: "/turnkey-brochures/images/cosmetic/hand_wash_plant_2.webp"
  },
  {
    ...
    image: "/turnkey-brochures/images/cosmetic/hand_wash_plant_3.webp"
  },
  {
    ...
    image: "/turnkey-brochures/images/cosmetic/hand_wash_plant_4.webp"
  },
  {
    ...
    image: "/turnkey-brochures/images/cosmetic/hand_wash_plant_5.webp"
  },
  {
    ...
    image: "/turnkey-brochures/images/cosmetic/hand_wash_plant_6.webp"
  }
]
...
const GALLERY_IMAGES = [
  { id: 1, src: '/turnkey-brochures/images/cosmetic/hand_wash_plant_1.webp', alt: 'Raw Material Weighing & Mixing System' },
  { id: 2, src: '/turnkey-brochures/images/cosmetic/hand_wash_plant_2.webp', alt: 'Jacketed Mixing Tank with Agitator' },
  { id: 3, src: '/turnkey-brochures/images/cosmetic/hand_wash_plant_3.webp', alt: 'Inline Homogenizer & Filtration' },
  { id: 4, src: '/turnkey-brochures/images/cosmetic/hand_wash_plant_4.webp', alt: 'Intermediate Storage Tank' },
  { id: 5, src: '/turnkey-brochures/images/cosmetic/hand_wash_plant_5.webp', alt: 'Automatic Bottle Filling & Capping' },
  { id: 6, src: '/turnkey-brochures/images/cosmetic/hand_wash_plant_6.webp', alt: 'Labeling & Carton Packing System' }
]

export default function HandWashManufacturingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Hand Wash Manufacturing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Hand Wash Manufacturing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/cosmetic/hand_wash_hero.webp')`, backgroundColor: '#333' }} />
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Hand Wash <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Capitalize on the global market with our <strong>Hand Wash Manufacturing Plant</strong>. We deliver cutting-edge technology for processing Hand Wash, ensuring high yield and premium quality.</p>
              <p>The manufacturing process is meticulously designed to handle the specific requirements of Hand Wash production. From raw material intake to the final packaged product, every step is optimized for hygiene, speed, and consistency.</p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Hand Wash Manufacturing Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="HandWashManufacturingPlantDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Hand Wash Plant?</h2>
            <p>
