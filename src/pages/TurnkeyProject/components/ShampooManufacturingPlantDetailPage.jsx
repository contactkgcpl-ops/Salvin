...
const GALLERY_IMAGES = [
  { id: 1, src: '/assets/plants/cosmetics/cosmetic/shampoo_plant_1.webp', alt: 'Raw Material Weighing & Dosing System' },
  { id: 2, src: '/assets/plants/cosmetics/cosmetic/shampoo_plant_2.webp', alt: 'Main Mixing Tank' },
  { id: 3, src: '/assets/plants/cosmetics/cosmetic/shampoo_plant_3.webp', alt: 'High Shear Mixer' },
  { id: 4, src: '/assets/plants/cosmetics/cosmetic/shampoo_plant_4.webp', alt: 'Storage Tanks' },
  { id: 5, src: '/assets/plants/cosmetics/cosmetic/shampoo_plant_5.webp', alt: 'Filling & Capping Machine' },
  { id: 6, src: '/assets/plants/cosmetics/cosmetic/shampoo_plant_6.webp', alt: 'Labeling & Packaging Machine' }
]
...
export default function ShampooManufacturingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Shampoo Manufacturing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Shampoo Manufacturing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/plants/cosmetics/cosmetic/shampoo_hero.webp')`, backgroundColor: '#333' }} />
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Shampoo <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Capitalize on the global market with our <strong>Shampoo Manufacturing Plant</strong>. We deliver cutting-edge technology for processing Shampoo, ensuring high yield and premium quality.</p>
              <p>The manufacturing process is meticulously designed to handle the specific requirements of Shampoo production. From raw material intake to the final packaged product, every step is optimized for hygiene, speed, and consistency.</p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Shampoo Manufacturing Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="ShampooManufacturingPlantDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Shampoo Plant?</h2>
            <p>
