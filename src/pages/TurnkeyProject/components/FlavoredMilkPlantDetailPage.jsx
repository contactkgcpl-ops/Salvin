...
const MACHINERY_LIST = [

  {
    ...
    "image": "/assets/plants/beverages/flavored-milk-gallery/1.webp"
  },
  {
    "name": "Pasteurization & Homogenization System",
    "desc": "Skid-mounted heating, homogenizing, and pasteurization unit.",
    "image": "/assets/plants/beverages/flavored-milk-gallery/2.webp"
  },
  {
    "name": "Flavored Milk Blending & Mixing Tank",
    "desc": "Tanks for blending sugar, colors, and flavors uniformly.",
    "image": "/assets/plants/beverages/flavored-milk-gallery/3.webp"
  },
  {
    "name": "Holding & Buffer Storage Tank",
    "desc": "Maintains temperature and consistency before filling.",
    "image": "/assets/plants/beverages/flavored-milk-gallery/4.webp"
  },
  {
    "name": "High-Speed Automatic Bottle Filling Line",
    "desc": "Automatically rinses, fills, and caps flavored milk bottles.",
    "image": "/assets/plants/beverages/flavored-milk-gallery/5.webp"
  },
  {
    "name": "Automated Carton Packing & Dispatch",
    "desc": "End-of-line packaging for carton sealing and palletizing.",
    "image": "/assets/plants/beverages/flavored-milk-gallery/6.webp"
  }
]
/* â”€â”€â”€ FAQs â”€â”€â”€ */
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Fully Automated Flavored Milk Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Fully Automated Flavored Milk Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
...
const GALLERY_IMAGES = [
  {
    "src": "/assets/plants/beverages/flavored-milk-gallery/1.webp",
    "caption": "Raw Milk Storage & Initial Processing"
  },
  {
    "src": "/assets/plants/beverages/flavored-milk-gallery/2.webp",
    "caption": "Pasteurization & Homogenization System"
  },
  {
    "src": "/assets/plants/beverages/flavored-milk-gallery/3.webp",
    "caption": "Flavored Milk Blending & Mixing Tank"
  },
  {
    "src": "/assets/plants/beverages/flavored-milk-gallery/4.webp",
    "caption": "Holding & Buffer Storage Tank"
  },
  {
    "src": "/assets/plants/beverages/flavored-milk-gallery/5.webp",
    "caption": "High-Speed Automatic Bottle Filling Line"
  },
  {
    "src": "/assets/plants/beverages/flavored-milk-gallery/6.webp",
    "caption": "Automated Carton Packing & Dispatch"
  }
]

export default function FlavoredMilkPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automated Flavored Milk Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automated Flavored Milk Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/plants/beverages/beverage-heroes/hero_flavored_milk.webp')` }} />
        <div className="rcp-hero__content">
          ...
          <h1 className="rcp-hero__title">
            Fully Automated Flavored Milk Plant
          </h1>
          <p className="rcp-hero__subtitle">
            Start Your Own Fully Automated Flavored Milk Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Flavored Milk <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Fully Automated Flavored Milk Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Flavored Milk Processing Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Flavored Milk Plant?</h2>
            <p>
          ...
          <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
            ...
            <div className="rcp-seo-content__body">
              <div className="rcp-seo-content__block">
                <h3>Why Start a Fully Automated Flavored Milk Plant Business?</h3>
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Fully Automated Flavored Milk Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
