...
const GALLERY_IMAGES = [
  {
    "src": "/turnkey-brochures/images/syrup-manufacturing-gallery/1.jpg",
    "caption": "Water Treatment & RO System (Sugar Dissolving Tank)"
  },
  {
    "src": "/turnkey-brochures/images/syrup-manufacturing-gallery/2.jpg",
    "caption": "Syrup Mixing Tank (Cap. 5000 LTR.)"
  },
  {
    "src": "/turnkey-brochures/images/syrup-manufacturing-gallery/3.jpg",
    "caption": "Filtration, Homogenizer & Pasteurization Unit"
  },
  {
    "src": "/turnkey-brochures/images/syrup-manufacturing-gallery/4.jpg",
    "caption": "Syrup Cooling Unit & Storage Tank (Cap. 10000 LTR.)"
  },
  {
    "src": "/turnkey-brochures/images/syrup-manufacturing-gallery/5.jpg",
    "caption": "Automatic Filling, Capping & Sealing Machine"
  },
  {
    "src": "/turnkey-brochures/images/syrup-manufacturing-gallery/6.jpg",
    "caption": "Labeling, Carton Packing & Palletizing System"
  }
]

export default function SyrupManufacturingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automatic Syrup Manufacturing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automatic Syrup Manufacturing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/beverage-heroes/hero_syrup.png')` }} />
        <div className="rcp-hero__content">
          ...
          <h1 className="rcp-hero__title">
            Fully Automatic Syrup Manufacturing Plant
          </h1>
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Syrup Manufacturing <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Produce high-quality concentrated syrups, squashes, and flavorings with our <strong>Fully Automatic Syrup Manufacturing Plant</strong>. Syrups are the foundation for countless beverages, desserts, and even medicinal products.</p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Syrup Manufacturing Processing Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Syrup Manufacturing Plant?</h2>
            <p>
        ...
        <section className="rcp-section rcp-seo-content" id="seo-guide" data-animate>
          <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
            ...
            <h2 className="rcp-section-title">A Simple Guide to <span className="rcp-accent">Syrup Manufacturing Processing</span></h2>
            <p className="rcp-section-subtitle">Understanding the processing workflow, accuracy, and market impact.</p>
            <div className="rcp-seo-content__body">
              <div className="rcp-seo-content__block">
                <h3>Why Start a Syrup Manufacturing Business?</h3>
                <p>The demand for high-quality, hygienically processed Syrup Manufacturing is growing rapidly in both domestic and international markets. Setting up an automated, high-capacity industrial plant ensures a highly profitable, recurring FMCG business with excellent ROI. Modern consumers prioritize branded, untouched-by-hand products, making industrial automation the key to market success.</p>
              </div>
              
              <div className="rcp-seo-content__block">
                <h3>How Does the Syrup Manufacturing Processing Work?</h3>
