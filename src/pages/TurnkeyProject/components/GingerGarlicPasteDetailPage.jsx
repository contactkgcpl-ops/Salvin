...
export default function GingerGarlicPasteDetailPage() {
  ...
  return (
    <div className="ggp-page">
      ...
      {/* ═══ BENEFITS / ADVANTAGES ═══ */}
      <section className="ggp-section ggp-why-salvin" id="why-salvin" data-animate>
        <div className={`ggp-container ggp-animate ${isVisible['why-salvin'] ? 'ggp-animate--in' : ''}`}>
          <div className="ggp-section-badge">Key Benefits</div>
          <h2 className="ggp-section-title">Plant <span className="ggp-accent">Advantages</span></h2>
          <div className="ggp-why-salvin__grid">
            {/* Card 1 */}
            <div className="ggp-why-salvin__card">
              <div className="ggp-why-salvin__icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="3" />
                  <path d="M12 1v4M12 19v4M4.22 4.22l2.83 2.83M16.95 16.95l2.83 2.83M1 12h4M19 12h4M4.22 19.78l2.83-2.83M16.95 7.05l2.83-2.83" />
                </svg>
              ...
              <div>
                <p className="ggp-why-salvin__title">Consistent Paste Quality</p>
                <p className="ggp-why-salvin__desc">Ensures uniform texture, flavor retention, and optimal processing.</p>
              </div>
            </div>
            {/* Card 2 */}
            <div className="ggp-why-salvin__card">
              ...
              <div>
                <p className="ggp-why-salvin__title">Hygienic Production</p>
                <p className="ggp-why-salvin__desc">Constructed with high-grade stainless steel to ensure food safety.</p>
              </div>
            </div>
            {/* Card 3 */}
            <div className="ggp-why-salvin__card">
              ...
              <div>
                <p className="ggp-why-salvin__title">Reduced Labor Cost</p>
                <p className="ggp-why-salvin__desc">High automation reduces the need for manual handling and labor expenses.</p>
              </div>
            </div>
            {/* Card 4 */}
            <div className="ggp-why-salvin__card">
              ...
              <div>
                <p className="ggp-why-salvin__title">High Processing Capacity</p>
                <p className="ggp-why-salvin__desc">Efficient workflow supports high volume processing with minimal downtime.</p>
              </div>
            </div>
            {/* Card 5 */}
            <div className="ggp-why-salvin__card">
              ...
              <div>
                <p className="ggp-why-salvin__title">Longer Shelf Life</p>
                <p className="ggp-why-salvin__desc">Optimized milling and packaging extend the product's natural shelf life.</p>
              </div>
            </div>
            {/* Card 6 */}
            <div className="ggp-why-salvin__card">
              ...
              <div>
                <p className="ggp-why-salvin__title">Easy Plant Operation</p>
                <p className="ggp-why-salvin__desc">User-friendly controls and automated systems ensure smooth functioning.</p>
              </div>
            </div>
          </div>
        </div>
