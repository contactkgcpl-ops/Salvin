...
const MACHINERY_LIST = [

  {
    ...
    image: '/assets/plants/food/extruded-snacks/media__1785501004052.webp',
    desc: 'Salvin Industries builds this automatic system. It handles the initial processing stage with high efficiency before moving to the next machine.'
  },
  {
    name: 'Bucket Elevator & Hopper',
    image: '/assets/plants/food/extruded-snacks/media__1785501050102.webp',
    desc: 'Our heavy-duty machine is designed for maximum yield and perfect product quality automatically.'
  },
  {
    name: 'Twin Screw Extruder',
    image: '/assets/plants/food/extruded-snacks/media__1785501019282.webp',
    desc: 'This machine processes your product smoothly. It makes sure the final output is completely consistent without any human touch.'
  },
  {
    name: 'Vibratory Sifter & Cooler',
    image: '/assets/plants/food/extruded-snacks/media__1785501027619.webp',
    desc: 'We manufacture this machine to handle the core processing. It works continuously while keeping the natural taste and quality safe.'
  },
  {
    name: 'Rotary Seasoning Drum',
    image: '/assets/plants/food/extruded-snacks/media__1785501037572.webp',
    desc: 'This is a very important machine in the line. It ensures your product is processed hygienically for a long shelf life.'
  },
  {
    name: 'Automatic Packaging Machine',
    image: '/assets/plants/food/extruded-snacks/media__1785501060641.webp',
...
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Fully Automatic Extruded Snacks Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Fully Automatic Extruded Snacks Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
...
const GALLERY_IMAGES = [
  { src: '/assets/plants/food/extruded-snacks/media__1785501004052.webp', caption: 'Ribbon Blender Mixer' },
  { src: '/assets/plants/food/extruded-snacks/media__1785501050102.webp', caption: 'Material Feeding Elevator' },
  { src: '/assets/plants/food/extruded-snacks/media__1785501019282.webp', caption: 'Twin Screw Extruder Unit' },
  { src: '/assets/plants/food/extruded-snacks/media__1785501027619.webp', caption: 'Vibratory Sifter & Cooling Conveyor' },
  { src: '/assets/plants/food/extruded-snacks/media__1785501037572.webp', caption: 'Continuous Rotary Seasoning Drum' },
  { src: '/assets/plants/food/extruded-snacks/media__1785501060641.webp', caption: 'Automatic Pouch Packing Machine' }
]
  ...
  return (
    <div className="faesp-page">
      ...
      <section className="faesp-hero">
        ...
        <div className="faesp-hero__bg" style={{ backgroundImage: `url('/assets/plants/food/hero_extruded_snacks.webp')` }} />
        <div className="faesp-hero__content">
          ...
          <p className="faesp-hero__subtitle">
            Start Your Own Fully Automatic Extruded Snacks Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
        ...
        <div className={`faesp-container faesp-animate ${isVisible['overview'] ? 'faesp-animate--in' : ''}`}>
          ...
          <div className="faesp-overview__grid">
            <div className="faesp-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Fully Automatic Extruded Snacks Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
            ...
            <div className="faesp-overview__image faesp-overview__image--photo">
              <img src="/assets/plants/food/extruded-snacks/media__1785501019282.webp" alt="Fully Automatic Extruded Snacks Plant by Salvin Industries" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="faesp-section faesp-process-new" id="process-flow" data-animate>
        ...
        <section className="faesp-section faesp-seo-content" id="seo-guide" data-animate>
          <div className={`faesp-container faesp-animate ${isVisible['seo-guide'] ? 'faesp-animate--in' : ''}`}>
            <div className="faesp-section-badge">ABOUT THE PLANT</div>
            <h2 className="faesp-section-title">How Does The <span className="faesp-accent">Plant Work?</span></h2>
            <p className="faesp-section-subtitle">A simple explanation of the machinery and process by Salvin Industries.</p>
            <div className="faesp-seo-content__body">
              <div className="faesp-seo-content__block">
                ...
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Fully Automatic Extruded Snacks Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
