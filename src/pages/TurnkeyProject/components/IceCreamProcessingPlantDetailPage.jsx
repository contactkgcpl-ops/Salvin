...
const MACHINERY_LIST = [

  {
    ...
    "image": "/assets/plants/dairy/ice-cream-gallery/1.webp"
  },
  {
    "name": "Mix Preparation & Pasteurization",
    "desc": "Skid-mounted mixing, heating, and homogenizing unit.",
    "image": "/assets/plants/dairy/ice-cream-gallery/2.webp"
  },
  {
    "name": "Ice Cream Aging Tank",
    "desc": "Chilled tanks to let the mix rest and hydrate.",
    "image": "/assets/plants/dairy/ice-cream-gallery/3.webp"
  },
  {
    "name": "Continuous Ice Cream Freezer",
    "desc": "Whips air (overrun) and freezes the mix instantly.",
    "image": "/assets/plants/dairy/ice-cream-gallery/4.webp"
  },
  {
    "name": "Automatic Cup & Cone Filling",
    "desc": "Automatically fills and caps cups, cones, and tubs.",
    "image": "/assets/plants/dairy/ice-cream-gallery/5.webp"
  },
  {
    "name": "Hardening Tunnel",
    "desc": "Deep freezes the product at -30°C to lock the texture.",
    "image": "/assets/plants/dairy/ice-cream-gallery/6.webp"
  }
]
/* ─── FAQs ─── */
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Fully Automatic Ice Cream Processing Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Fully Automatic Ice Cream Processing Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
...
const GALLERY_IMAGES = [
  {
    "src": "/assets/plants/dairy/ice-cream-gallery/1.webp",
    "caption": "Raw Milk Reception System"
  },
  {
    "src": "/assets/plants/dairy/ice-cream-gallery/2.webp",
    "caption": "Mix Preparation & Pasteurization"
  },
  {
    "src": "/assets/plants/dairy/ice-cream-gallery/3.webp",
    "caption": "Ice Cream Aging Tank"
  },
  {
    "src": "/assets/plants/dairy/ice-cream-gallery/4.webp",
    "caption": "Continuous Ice Cream Freezer"
  },
  {
    "src": "/assets/plants/dairy/ice-cream-gallery/5.webp",
    "caption": "Automatic Cup & Cone Filling"
  },
  {
    "src": "/assets/plants/dairy/ice-cream-gallery/6.webp",
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/core/heroes/dairy-heroes/ice-cream.webp')` }} />
        <div className="rcp-hero__content">
          ...
          <p className="rcp-hero__subtitle">
            Start Your Own Fully Automatic Ice Cream Processing Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
        ...
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Fully Automatic Ice Cream Processing Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
          ...
          <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
            ...
            <div className="rcp-seo-content__body">
              <div className="rcp-seo-content__block">
                <h3>Why Start a Fully Automatic Ice Cream Processing Plant Business?</h3>
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Fully Automatic Ice Cream Processing Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
