    ...
    <div className="rcp-page">
        ...
        <div className={`rcp-container rcp-animate ${isVisible["overview"] ? "rcp-animate--in" : ""}`}>
          ...
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p><strong>Salvin Industries' Spice Blending Plant</strong> is a specialized turnkey solution engineered for creating perfectly homogeneous spice mixtures. Our advanced ribbon blenders and paddle mixers guarantee that every single pouch of your mixed spice has the exact same uniform taste.</p>
      ...
      <section className="rcp-section rcp-seo-content" id="seo-guide" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible["seo-guide"] ? "rcp-animate--in" : ""}`}>
          ...
          <h2 className="rcp-section-title">A Simple Guide to <span className="rcp-accent">Spice Blending</span></h2>
          <p className="rcp-section-subtitle">Understanding recipe consistency, industrial mixing, and market success.</p>
