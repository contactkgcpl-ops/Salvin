...
const FAQS = [
  {
    question: "What is the processing capacity of the Fully Automated Corn Flour Plant?",
  ...
  {
    question: "Can the plant process different types of corn floures?",
    answer: "Yes. The plant is designed to handle various corn flour varieties while maintaining product quality, color, and consistency."
  },
  {
  ...
  {
    question: "Why choose SALVIN for Fully Automated Corn Flour Plants?",
      ...
      <section className="facfp-hero">
        ...
        <div className="facfp-hero__content">
          ...
          <p className="facfp-hero__subtitle">
            Complete Turnkey Solution For Cleaning, Drying, Grinding, Pulverizing And Packaging Of Corn Flour
          </p>
        ...
        <div className={`facfp-container facfp-animate ${isVisible['overview'] ? 'facfp-animate--in' : ''}`}>
          ...
          <div className="facfp-overview__grid">
            <div className="facfp-overview__text">
              <p>
                Salvin Industries' Fully Automated Corn Flour Plant is a turnkey industrial solution designed for processors who demand
                consistent quality, high throughput, and full regulatory compliance. Our integrated processing line handles every stage
                — from incoming raw corn flour inspection through final packaged product — in a single, automated, dust-free facility.
              </p>
              <p>
                Each plant is custom-engineered to match your specific capacity requirements, product grades, and market standards.
                Whether you're producing retail packs, bulk institutional supply, or export-grade corn flour powder, our systems deliver
      ...
      <section className="facfp-section facfp-process-new" id="process-flow" data-animate>
        ...
        <section className="facfp-section facfp-seo-content" id="seo-guide" data-animate>
          <div className={`facfp-container facfp-animate ${isVisible['seo-guide'] ? 'facfp-animate--in' : ''}`}>
            <div className="facfp-section-badge">COMPREHENSIVE GUIDE</div>
            <h2 className="facfp-section-title">A Simple Guide to <span className="facfp-accent">Fully Automated Corn Flour Plant Processing</span></h2>
            <p className="facfp-section-subtitle">Understanding the processing workflow, accuracy, and market impact.</p>
