...
const PROCESS_STEPS = [
  ...
  {
    "id": 6,
    "title": "Cooling & Granulation"
  },
  {
    "id": 7,
    "title": "Tin/Jar Filling"
  }
]
...
const FAQS = [
  ...
  {
    "question": "How do you achieve the 'Danedar' (granular) texture?",
    "answer": "The granular texture is achieved by carefully controlling the cooling rate in our specialized granulation tanks before packing."
  }
];
...
const GALLERY_IMAGES = [
  {
    "src": "/turnkey-brochures/images/ghee-gallery/1.jpg",
    "caption": "Raw Milk Reception & Chilling"
  },
  {
    "src": "/turnkey-brochures/images/ghee-gallery/2.jpg",
    "caption": "Cream Separator & Storage"
  },
  {
    "src": "/turnkey-brochures/images/ghee-gallery/3.jpg",
    "caption": "Cream Pasteurization & Ripening"
  },
  {
    "src": "/turnkey-brochures/images/ghee-gallery/4.jpg",
    "caption": "Automatic Butter Churning"
  },
  {
    "src": "/turnkey-brochures/images/ghee-gallery/5.jpg",
    "caption": "Ghee Clarification & Filtration"
  },
  {
    "src": "/turnkey-brochures/images/ghee-gallery/6.jpg",
    "caption": "Automatic Ghee Filling & Packaging"
  }
]

export default function GheePlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automatic Ghee Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automatic Ghee Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/dairy-heroes/ghee.png')` }} />
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Ghee <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Start a highly successful business with our <strong>Fully Automatic Ghee Plant</strong>. Processed food products are a daily essential in every household, ensuring continuous, high-volume market demand all year round.</p>
      ...
      <section className="rcp-section rcp-seo-content" id="seo-guide" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title" dangerouslySetInnerHTML={{ __html: `A Simple Guide to <span class='rcp-accent'>Ghee Packaging</span>` }} />
          <p className="rcp-section-subtitle">Understanding the packaging process, accuracy, and market impact.</p>
          <div className="rcp-seo-content__body">
            <div className="rcp-seo-content__block">
              <h3>Why Start a Ghee Business?</h3>
              <p>Ghee is the heart of Indian and South Asian cooking. The demand for branded, high-quality, and hygienically packed blended spices and food products is skyrocketing. By manufacturing a perfectly balanced and highly aromatic Ghee, you can build a highly profitable and recurring FMCG business.</p>
            </div>
            
            <div className="rcp-seo-content__block">
              <h3>How Does the Ghee Processing Work?</h3>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Ghee Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Ghee Plant?</h2>
            <p>
