...
const MACHINERY_LIST = [

  {
    ...
    image: '/assets/plants/food/rice-processing/media__1785502089150.webp',
    desc: 'Salvin Industries builds this automatic system. It handles the initial processing stage with high efficiency before moving to the next machine.'
  },
  {
    name: 'Destoner & Paddy Grader',
    image: '/assets/plants/food/rice-processing/media__1785502097389.webp',
    desc: 'Our heavy-duty machine is designed for maximum yield and perfect product quality automatically.'
  },
  {
    name: 'Rubber Roll Husker',
    image: '/assets/plants/food/rice-processing/media__1785502106999.webp',
    desc: 'This machine processes your product smoothly. It makes sure the final output is completely consistent without any human touch.'
  },
  {
    name: 'Paddy Separator',
    image: '/assets/plants/food/rice-processing/media__1785502116773.webp',
    desc: 'We manufacture this machine to handle the core processing. It works continuously while keeping the natural taste and quality safe.'
  },
  {
    name: 'Rice Length Grader & Color Sorter',
    image: '/assets/plants/food/rice-processing/media__1785502126732.webp',
    desc: 'This is a very important machine in the line. It ensures your product is processed hygienically for a long shelf life.'
  },
  {
    name: 'Automatic Bagging Machine',
    image: '/assets/plants/food/rice-processing/media__1785502136873.webp',
...
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Fully Automated Rice Processing Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Fully Automated Rice Processing Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
...
const GALLERY_IMAGES = [
  { src: '/assets/plants/food/rice-processing/media__1785502089150.webp', caption: 'Paddy Pre-Cleaner' },
  { src: '/assets/plants/food/rice-processing/media__1785502097389.webp', caption: 'Destoner & Paddy Grader' },
  { src: '/assets/plants/food/rice-processing/media__1785502106999.webp', caption: 'Rubber Roll Husker' },
  { src: '/assets/plants/food/rice-processing/media__1785502116773.webp', caption: 'Paddy Separator' },
  { src: '/assets/plants/food/rice-processing/media__1785502126732.webp', caption: 'Rice Length Grader & Color Sorter' },
  { src: '/assets/plants/food/rice-processing/media__1785502136873.webp', caption: 'Automatic Bagging Machine' }
]
  ...
  return (
    <div className="farpp-page">
      ...
      <section className="farpp-hero">
        ...
        <div className="farpp-hero__bg" style={{ backgroundImage: `url('/assets/plants/food/hero_rice.webp')` }} />
        <div className="farpp-hero__content">
          ...
          <p className="farpp-hero__subtitle">
            Start Your Own Fully Automated Rice Processing Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
        ...
        <div className={`farpp-container farpp-animate ${isVisible['overview'] ? 'farpp-animate--in' : ''}`}>
          ...
          <div className="farpp-overview__grid">
            <div className="farpp-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Fully Automated Rice Processing Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
            ...
            <div className="farpp-overview__image farpp-overview__image--photo">
              <img src="/assets/plants/food/rice-processing/media__1785502116773.webp" alt="Fully Automated Rice Processing Plant by Salvin Industries" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="farpp-section farpp-process-new" id="process-flow" data-animate>
        ...
        <section className="farpp-section farpp-seo-content" id="seo-guide" data-animate>
          <div className={`farpp-container farpp-animate ${isVisible['seo-guide'] ? 'farpp-animate--in' : ''}`}>
            <div className="farpp-section-badge">ABOUT THE PLANT</div>
            <h2 className="farpp-section-title">How Does The <span className="farpp-accent">Plant Work?</span></h2>
            <p className="farpp-section-subtitle">A simple explanation of the machinery and process by Salvin Industries.</p>
            <div className="farpp-seo-content__body">
              <div className="farpp-seo-content__block">
                ...
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Fully Automated Rice Processing Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
