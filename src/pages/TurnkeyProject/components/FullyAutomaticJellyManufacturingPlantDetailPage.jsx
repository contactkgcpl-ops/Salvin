...
const PROCESS_STEPS = [
  {
    "id": 1,
    "title": "Sugar Dissolving & Syrup Preparation"
  },
  {
    "id": 2,
    "title": "Pectin & Ingredient Blending"
  },
  {
    "id": 3,
    "title": "Continuous Vacuum Cooking"
  },
  {
    "id": 4,
    "title": "Inline Flavor & Color Dosing"
  },
  {
    "id": 5,
    "title": "Automated Cup Filling"
  },
  {
    "id": 6,
    "title": "Cooling Tunnel Setting"
  },
  {
    "id": 7,
    "title": "Sealing & Carton Packaging"
  }
];
...
const MACHINERY_LIST = [

  {
    ...
    "image": "/assets/plants/food/jelly-gallery/ingredient_mixing.webp",
  ...
  },
  {
    ...
    "image": "/assets/plants/food/jelly-gallery/vacuum_cooking.webp",
  ...
  },
  {
    ...
    "image": "/assets/plants/food/jelly-gallery/jelly_depositing.webp",
  ...
  },
  {
    ...
    "image": "/assets/plants/food/jelly-gallery/cooling_tunnel.webp",
  ...
  },
  {
    ...
    "image": "/assets/plants/food/jelly-gallery/sugar_coating.webp",
  ...
  },
  {
    ...
    "image": "/assets/plants/food/jelly-gallery/pouch_packing.webp",
...
const GALLERY_IMAGES = [
  { src: "/assets/plants/food/jelly-gallery/ingredient_mixing.webp", caption: "Ingredient Mixing & Preparation Tank" },
  { src: "/assets/plants/food/jelly-gallery/vacuum_cooking.webp", caption: "Vacuum Cooking System" },
  { src: "/assets/plants/food/jelly-gallery/jelly_depositing.webp", caption: "Automatic Jelly Depositing & Moulding Machine" },
  { src: "/assets/plants/food/jelly-gallery/cooling_tunnel.webp", caption: "Cooling Tunnel & Demoulding Conveyor" },
  { src: "/assets/plants/food/jelly-gallery/sugar_coating.webp", caption: "Sugar & Oil Coating / Polishing Machine" },
  { src: "/assets/plants/food/jelly-gallery/pouch_packing.webp", caption: "Automatic Jelly Pouch Filling & Packing Machine" }
];
...
export default function FullyAutomaticJellyManufacturingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = "Fully Automatic Jelly Manufacturing Plant | Turnkey Solutions | Salvin Industries";
    const metaDesc = document.querySelector("meta[name='description']");
    if (metaDesc) metaDesc.setAttribute("content", "Invest in a Fully Automatic Jelly Manufacturing Plant by Salvin Industries. High-capacity commercial jelly making machines featuring vacuum cooking, flavor dosing, and cup packaging.");
  }, []);
  ...
  return (
    <div className="rcp-page">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: "url('/assets/plants/food/hero_jelly.webp')" }} />
        ...
        <div className={`rcp-container rcp-animate ${isVisible["overview"] ? "rcp-animate--in" : ""}`}>
          ...
          <div className="rcp-overview__grid">
            ...
            <div className="rcp-overview__image rcp-overview__image--photo">
              <img src="/assets/plants/food/hero_jelly.webp" alt="Fully Automatic Jelly Manufacturing Plant Overview" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
...
<React.Fragment key={1}>
  <div className="rcp-process-card">
    ...
    <div className="rcp-process-card__label" style={{ minWidth: "100px" }}>Sugar Dissolving & Syrup Preparation</div>
  </div>
</React.Fragment>
<React.Fragment key={2}>
  <div className="rcp-process-card">
    ...
    <div className="rcp-process-card__label" style={{ minWidth: "100px" }}>Pectin & Ingredient Blending</div>
  </div>
</React.Fragment>
<React.Fragment key={3}>
  <div className="rcp-process-card">
    ...
    <div className="rcp-process-card__label" style={{ minWidth: "100px" }}>Continuous Vacuum Cooking</div>
  </div>
</React.Fragment>
<React.Fragment key={4}>
  <div className="rcp-process-card">
    ...
    <div className="rcp-process-card__label" style={{ minWidth: "100px" }}>Inline Flavor & Color Dosing</div>
  </div>
</React.Fragment>
<React.Fragment key={5}>
  <div className="rcp-process-card">
    ...
    <div className="rcp-process-card__label" style={{ minWidth: "100px" }}>Automated Cup Filling</div>
  </div>
</React.Fragment>
<React.Fragment key={6}>
  <div className="rcp-process-card">
    ...
    <div className="rcp-process-card__label" style={{ minWidth: "100px" }}>Cooling Tunnel Setting</div>
  </div>
</React.Fragment>
<React.Fragment key={7}>
  <div className="rcp-process-card">
    ...
    <div className="rcp-process-card__label" style={{ minWidth: "100px" }}>Sealing & Carton Packaging</div>
  </div>
</React.Fragment>
          </div>
        </div>
      ...
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible["why-salvin"]} projectKey="FullyAutomaticJellyManufacturingPlantDetailPage" />
        ...
        <div className={`rcp-container rcp-animate ${isVisible["enquiry"] ? "rcp-animate--in" : ""}`}>
          <div className="rcp-cta__box">
            ...
            <div className="rcp-cta__actions">
              <a href={"https://wa.me/919898727796?text=I%20am%20interested%20in%20the%20Fully%20Automatic%20Jelly%20Manufacturing%20Plant.%20Please%20share%20details."} target="_blank" rel="noopener noreferrer" className="rcp-btn rcp-btn--primary rcp-btn--lg">
      ...
      <div className="rcp-back-nav">
        ...
        <section className="rcp-section rcp-seo-content" id="seo-guide" data-animate>
          <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
            ...
            <h2 className="rcp-section-title">A Simple Guide to <span className="rcp-accent">Fully Automatic Jelly Manufacturing Plant Processing</span></h2>
            <p className="rcp-section-subtitle">Understanding the processing workflow, accuracy, and market impact.</p>
            <div className="rcp-seo-content__body">
              <div className="rcp-seo-content__block">
                <h3>Why Start a Fully Automatic Jelly Manufacturing Plant Business?</h3>
                <p>The demand for high-quality, hygienically processed Fully Automatic Jelly Manufacturing Plant is growing rapidly in both domestic and international markets. Setting up an automated, high-capacity industrial plant ensures a highly profitable, recurring FMCG business with excellent ROI. Modern consumers prioritize branded, untouched-by-hand products, making industrial automation the key to market success.</p>
              </div>
              
              <div className="rcp-seo-content__block">
                <h3>How Does the Fully Automatic Jelly Manufacturing Plant Processing Work?</h3>
