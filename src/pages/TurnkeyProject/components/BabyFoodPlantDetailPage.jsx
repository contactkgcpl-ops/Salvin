...
const PROCESS_STEPS = [
  { id: 1, title: 'Ingredient Reception' },
  { id: 2, title: 'Mixing & Blending' },
  { id: 3, title: 'Homogenisation' },
  { id: 4, title: 'Heat Treatment' },
  { id: 5, title: 'Spray Drying' },
  { id: 6, title: 'Sieving' },
...
export default function BabyFoodPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Baby Food Plant | Turnkey Solutions | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey Baby Food Plant by Salvin Industries. From ingredient batching to finished powder packaging — automated, food-grade, energy-efficient processing lines from 200 Kg/Hr to 5 Ton/Hr.')
  }, [])
  useEffect(() => {
    ...
    <div className="opp-page">
            ...
            <div className="opp-overview__text">
              ...
              <div className="opp-overview__features">
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body"><p className="opp-overview__feature-title">Nutritional Precision</p><p className="opp-overview__feature-desc">Accurate micronutrient fortification per batch</p></div>
                </div>
                <div className="opp-overview__feature">
                ...
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body"><p className="opp-overview__feature-title">Consistent Quality</p><p className="opp-overview__feature-desc">Uniform moisture, particle size, and solubility</p></div>
                </div>
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body"><p className="opp-overview__feature-title">Energy Efficient</p><p className="opp-overview__feature-desc">Optimised steam and power consumption per ton</p></div>
                </div>
              </div>
            </div>
      ...
      <section className="opp-section opp-process-new" id="process-flow" data-animate>
        <div className={`opp-container opp-animate ${isVisible['process-flow'] ? 'opp-animate--in' : ''}`}>
          ...
          <h2 className="opp-section-title">Baby Food <span className="opp-accent">Processing Workflow</span></h2>
          <p className="opp-section-subtitle">A streamlined and fully integrated processing workflow designed to transform raw ingredients into premium-quality baby food powder while ensuring maximum hygiene, nutritional integrity, and superior output quality.</p>
      ...
      <section className="opp-section opp-faq-section" id="faq" data-animate>
        <div className={`opp-container opp-animate ${isVisible['faq'] ? 'opp-animate--in' : ''}`}>
          ...
          <p className="opp-section-subtitle">Everything you need to know about our Baby Food Plant.</p>
      ...
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="BabyFoodPlantDetailPage" />
      ...
      <section className="opp-section opp-cta" id="enquiry" data-animate>
        <div className={`opp-container opp-animate ${isVisible['enquiry'] ? 'opp-animate--in' : ''}`}>
          <div className="opp-cta__box">
            <h2>Ready to Build Your Baby Food Plant?</h2>
            ...
            <div className="opp-cta__actions">
              <a href="https://wa.me/919898727796?text=I%20am%20interested%20in%20the%20Baby%20Food%20Plant.%20Please%20share%20details." target="_blank" rel="noopener noreferrer" className="opp-btn opp-btn--primary opp-btn--lg">
