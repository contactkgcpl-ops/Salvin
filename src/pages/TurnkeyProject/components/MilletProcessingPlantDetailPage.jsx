...
const PROCESS_STEPS = [
  { id: 1, title: 'Millet Reception' },
  { id: 2, title: 'Cleaning & Sorting' },
  { id: 3, title: 'De-Husking' },
  { id: 4, title: 'Polishing' },
  { id: 5, title: 'Grading' },
  { id: 6, title: 'Milling / Flour' },
...
export default function MilletProcessingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Millet Processing Plant | Turnkey Solutions | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey Millet Processing Plant by Salvin Industries. From raw millet cleaning to finished grain and flour packaging — automated, food-grade, energy-efficient processing lines from 500 Kg/Hr to 10 Ton/Hr.')
  }, [])
  useEffect(() => {
    ...
    <div className="opp-page">
            ...
            <div className="opp-overview__text">
              ...
              <div className="opp-overview__features">
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body"><p className="opp-overview__feature-title">High Recovery</p><p className="opp-overview__feature-desc">Maximum grain recovery per tonne processed</p></div>
                </div>
                <div className="opp-overview__feature">
                ...
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body"><p className="opp-overview__feature-title">Consistent Quality</p><p className="opp-overview__feature-desc">Uniform colour, whiteness, and particle size</p></div>
                </div>
                <div className="opp-overview__feature">
                  ...
                  <div className="opp-overview__feature-body"><p className="opp-overview__feature-title">Energy Efficient</p><p className="opp-overview__feature-desc">Optimised power consumption per ton</p></div>
                </div>
              </div>
            </div>
      ...
      <section className="opp-section opp-process-new" id="process-flow" data-animate>
        <div className={`opp-container opp-animate ${isVisible['process-flow'] ? 'opp-animate--in' : ''}`}>
          ...
          <h2 className="opp-section-title">Millet <span className="opp-accent">Processing Workflow</span></h2>
          <p className="opp-section-subtitle">A streamlined and fully integrated processing workflow designed to transform raw millet into premium-quality processed grain and flour while ensuring maximum efficiency, product consistency and superior output quality.</p>
      ...
      <section className="opp-section opp-faq-section" id="faq" data-animate>
        <div className={`opp-container opp-animate ${isVisible['faq'] ? 'opp-animate--in' : ''}`}>
          ...
          <p className="opp-section-subtitle">Everything you need to know about our Millet Processing Plant.</p>
      ...
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="MilletProcessingPlantDetailPage" />
      ...
      <section className="opp-section opp-cta" id="enquiry" data-animate>
        <div className={`opp-container opp-animate ${isVisible['enquiry'] ? 'opp-animate--in' : ''}`}>
          <div className="opp-cta__box">
            <h2>Ready to Build Your Millet Processing Plant?</h2>
            ...
            <div className="opp-cta__actions">
              <a href="https://wa.me/919898727796?text=I%20am%20interested%20in%20the%20Millet%20Processing%20Plant.%20Please%20share%20details." target="_blank" rel="noopener noreferrer" className="opp-btn opp-btn--primary opp-btn--lg">
