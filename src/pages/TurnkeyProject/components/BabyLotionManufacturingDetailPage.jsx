...
const MACHINERY_LIST = [

  {
    ...
    image: '/turnkey-brochures/images/baby-lotion-gallery/1_weighing_dosing.png',
    desc: 'Salvin Industries builds this automatic system. It handles the initial processing stage with high efficiency before moving to the next machine.'
  },
  {
    name: 'Syrup Preparation System',
    image: '/turnkey-brochures/images/baby-lotion-gallery/2_vacuum_mixer.png',
    desc: 'Our heavy-duty machine is designed for maximum yield and perfect product quality automatically.'
  },
  {
    name: 'Baby Lotion Mass Mixer',
    image: '/turnkey-brochures/images/baby-lotion-gallery/3_high_shear.png',
    desc: 'This machine processes your product smoothly. It makes sure the final output is completely consistent without any human touch.'
  },
  {
    name: 'Baby Lotion Forming Machine',
    image: '/turnkey-brochures/images/baby-lotion-gallery/4_storage_tank.png',
    desc: 'We manufacture this machine to handle the core processing. It works continuously while keeping the natural taste and quality safe.'
  },
  {
    name: 'Baby Lotion Cutting Machine',
    image: '/turnkey-brochures/images/baby-lotion-gallery/5_filling_capping.png',
    desc: 'This is a very important machine in the line. It ensures your product is processed hygienically for a long shelf life.'
  },
  {
    name: 'Flow Wrapping & Packaging Machine',
    image: '/turnkey-brochures/images/baby-lotion-gallery/6_labeling_packing.jpg',
...
const GALLERY_IMAGES = [
  { src: '/turnkey-brochures/images/baby-lotion-gallery/1_weighing_dosing.png', caption: 'Ingredient Dosing & Mixing System' },
  { src: '/turnkey-brochures/images/baby-lotion-gallery/2_vacuum_mixer.png', caption: 'Syrup Preparation System' },
  { src: '/turnkey-brochures/images/baby-lotion-gallery/3_high_shear.png', caption: 'Baby Lotion Mass Mixer' },
  { src: '/turnkey-brochures/images/baby-lotion-gallery/4_storage_tank.png', caption: 'Baby Lotion Forming Machine' },
  { src: '/turnkey-brochures/images/baby-lotion-gallery/5_filling_capping.png', caption: 'Baby Lotion Cutting Machine' },
  { src: '/turnkey-brochures/images/baby-lotion-gallery/6_labeling_packing.jpg', caption: 'Flow Wrapping Machine' },
]
  ...
  return (
    <div className="blm-page">
      ...
      <section className="blm-hero">
        ...
        <div className="blm-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/cosmetic/baby_lotion_hero.png')` }} />
        ...
        <div className={`blm-container ${isVisible['overview'] ? 'blm-animate--in' : ''}`}>
          ...
          <div className="blm-overview__grid">
            ...
            <div className="blm-overview__image blm-overview__image--photo" style={{ backgroundColor: '#fff', padding: '10px', display: 'flex', justifyContent: 'center' }}>
              <img src={'/turnkey-brochures/images/baby-lotion-gallery/2_vacuum_mixer.png'} alt="Plant Overview" loading="lazy" style={{ objectFit: 'contain', width: '100%', height: '100%', maxHeight: '600px', borderRadius: '8px' }} />
            </div>
          </div>
        </div>
      </section>
