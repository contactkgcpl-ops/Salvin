...
const PROCESS_STEPS = [
  ...
  {
    "id": 2,
    "title": "Cream Pasteurization"
  },
  {
    "id": 3,
    "title": "Aging & Ripening"
  },
  {
    "id": 4,
  ...
  {
    "id": 5,
    "title": "Buttermilk Draining"
  },
  {
    "id": 6,
    "title": "Salting & Working"
  },
  {
    "id": 7,
    "title": "Block/Foil Packing"
  }
]
...
const FAQS = [
  ...
  {
    "question": "What is the difference between batch and continuous churning?",
    "answer": "Batch churns process a fixed amount at a time, ideal for smaller plants. Continuous churns process cream non-stop into butter, perfect for high-volume commercial production."
  }
];
...
const GALLERY_IMAGES = [
  {
    "src": "/turnkey-brochures/images/butter-gallery/1.jpg",
    "caption": "Raw Milk Reception & Clarification"
  },
  {
    "src": "/turnkey-brochures/images/butter-gallery/2.jpg",
    "caption": "Cream Pasteurization & Aging"
  },
  {
    "src": "/turnkey-brochures/images/butter-gallery/3.jpg",
    "caption": "Continuous Butter Churn"
  },
  {
    "src": "/turnkey-brochures/images/butter-gallery/4.jpg",
    "caption": "Butter Kneading & Forming"
  },
  {
    "src": "/turnkey-brochures/images/butter-gallery/5.jpg",
    "caption": "Automatic Butter Wrapping"
  },
  {
    "src": "/turnkey-brochures/images/butter-gallery/6.jpg",
    "caption": "Carton Packing & Cold Storage"
  }
]

export default function ButterProcessingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automated Butter Processing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automated Butter Processing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/dairy-heroes/butter.png')` }} />
        <div className="rcp-hero__content">
          ...
          <h1 className="rcp-hero__title">
            Fully Automated Butter Processing Plant
          </h1>
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Butter <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Start a highly successful business with our <strong>Fully Automated Butter Processing Plant</strong>. Processed food products are a daily essential in every household, ensuring continuous, high-volume market demand all year round.</p>
      ...
      <section className="rcp-section rcp-seo-content" id="seo-guide" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title" dangerouslySetInnerHTML={{ __html: `A Simple Guide to <span class='rcp-accent'>Butter Packaging</span>` }} />
          <p className="rcp-section-subtitle">Understanding the packaging process, accuracy, and market impact.</p>
          <div className="rcp-seo-content__body">
            <div className="rcp-seo-content__block">
              <h3>Why Start a Butter Business?</h3>
              <p>Butter is the heart of Indian and South Asian cooking. The demand for branded, high-quality, and hygienically packed blended spices and food products is skyrocketing. By manufacturing a perfectly balanced and highly aromatic Butter, you can build a highly profitable and recurring FMCG business.</p>
            </div>
            
            <div className="rcp-seo-content__block">
              <h3>How Does the Butter Processing Work?</h3>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Butter Processing Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Butter Plant?</h2>
            <p>
