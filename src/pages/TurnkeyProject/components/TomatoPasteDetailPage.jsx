...
const MACHINERY_LIST = [

  {
    ...
    image: '/assets/plants/food/tomato-paste-gallery/tomato_paste_1.webp',
    desc: 'Salvin Industries builds this automatic system. It handles the initial processing stage with high efficiency before moving to the next machine.'
  },
  {
    name: 'Tomato Pulping Line',
    image: '/assets/plants/food/tomato-paste-gallery/tomato_paste_2.webp',
    desc: 'Our heavy-duty machine is designed for maximum yield and perfect product quality automatically.'
  },
  {
    name: 'Tomato Paste Evaporation System',
    image: '/assets/plants/food/tomato-paste-gallery/tomato_paste_3.webp',
    desc: 'This machine processes your product smoothly. It makes sure the final output is completely consistent without any human touch.'
  },
  {
    name: 'Tomato Paste Mixing Tank',
    image: '/assets/plants/food/tomato-paste-gallery/tomato_paste_4.webp',
    desc: 'We manufacture this machine to handle the core processing. It works continuously while keeping the natural taste and quality safe.'
  },
  {
    name: 'Tomato Paste Sterilization Unit',
    image: '/assets/plants/food/tomato-paste-gallery/tomato_paste_5.webp',
    desc: 'This is a very important machine in the line. It ensures your product is processed hygienically for a long shelf life.'
  },
  {
    name: 'Automatic Tomato Paste Filling & Capping Machine',
    image: '/assets/plants/food/tomato-paste-gallery/tomato_paste_6.webp',
...
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Tomato Paste Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Tomato Paste Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
...
const GALLERY_IMAGES = [
  { src: '/assets/plants/food/tomato-paste-gallery/tomato_paste_1.webp', caption: 'Tomato Washing & Sorting Machine' },
  { src: '/assets/plants/food/tomato-paste-gallery/tomato_paste_2.webp', caption: 'Tomato Pulping Line' },
  { src: '/assets/plants/food/tomato-paste-gallery/tomato_paste_3.webp', caption: 'Tomato Paste Evaporation System' },
  { src: '/assets/plants/food/tomato-paste-gallery/tomato_paste_4.webp', caption: 'Tomato Paste Mixing Tank' },
  { src: '/assets/plants/food/tomato-paste-gallery/tomato_paste_5.webp', caption: 'Tomato Paste Sterilization Unit' },
  { src: '/assets/plants/food/tomato-paste-gallery/tomato_paste_6.webp', caption: 'Automatic Filling & Capping Machine' }
]
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/core/heroes/hero-banners/tomato_paste_hero.webp')` }} />
        <div className="rcp-hero__content">
          ...
          <p className="rcp-hero__subtitle">
            Start Your Own Tomato Paste Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
        ...
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Tomato Paste Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
            ...
            <div className="rcp-overview__image rcp-overview__image--photo">
              <img src="/assets/plants/food/tomato-paste-gallery/tomato_paste_2.webp" alt="Tomato Pulping Line" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
            ...
            <div className="rcp-seo-content__body">
              <div className="rcp-seo-content__block">
                <h3>Why Start a Tomato Paste Plant Business?</h3>
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Tomato Paste Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
