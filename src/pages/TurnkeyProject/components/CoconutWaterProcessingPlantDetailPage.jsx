...
const MACHINERY_LIST = [

  {
    ...
    "image": "/assets/plants/beverages/coconut-water-gallery/1.webp"
  },
  {
    "name": "Extraction & Filtration Unit",
    "desc": "Hygienic coconut water extraction followed by advanced filtration.",
    "image": "/assets/plants/beverages/coconut-water-gallery/2.webp"
  },
  {
    "name": "Pasteurization & Sterilization",
    "desc": "Eliminates bacteria and enzymes to preserve natural flavor and shelf life.",
    "image": "/assets/plants/beverages/coconut-water-gallery/3.webp"
  },
  {
    "name": "Cooling & Storage System",
    "desc": "Rapid cooling using PHE and hygienic storage in stainless steel tanks.",
    "image": "/assets/plants/beverages/coconut-water-gallery/4.webp"
  },
  {
    "name": "Filling & Sealing Machine",
    "desc": "Automatic aseptic filling in bottles or tetra packs.",
    "image": "/assets/plants/beverages/coconut-water-gallery/5.webp"
  },
  {
    "name": "Labeling & Carton Packing",
    "desc": "End-of-line labeling, shrink wrapping, and carton packaging.",
    "image": "/assets/plants/beverages/coconut-water-gallery/6.webp"
  }
]
/* â”€â”€â”€ FAQs â”€â”€â”€ */
const FAQS = [
  {
    question: "Do you manufacture all the machines for the Fully Automated Coconut Water Processing Plant?",
    answer: "Yes! At Salvin Industries, we manufacture the complete range of machines required for a Fully Automated Coconut Water Processing Plant. From the first processing machine to the final packing machine, we build everything in our factory."
  },
  {
...
const GALLERY_IMAGES = [
  {
    "src": "/assets/plants/beverages/coconut-water-gallery/1.webp",
    "caption": "Coconut Washing, Sorting & Dehusking System"
  },
  {
    "src": "/assets/plants/beverages/coconut-water-gallery/2.webp",
    "caption": "Extraction & Filtration Unit (Micron & Carbon Filter)"
  },
  {
    "src": "/assets/plants/beverages/coconut-water-gallery/3.webp",
    "caption": "Deaeration, Pasteurization & Sterilization Unit"
  },
  {
    "src": "/assets/plants/beverages/coconut-water-gallery/4.webp",
    "caption": "Plate Heat Exchanger & Cooling Storage Tank"
  },
  {
    "src": "/assets/plants/beverages/coconut-water-gallery/5.webp",
    "caption": "Automatic Bottle / Tetra Pack Filling & Sealing"
  },
  {
    "src": "/assets/plants/beverages/coconut-water-gallery/6.webp",
    "caption": "Labeling, Shrink Wrapping & Carton Packing Machine"
  }
]

export default function CoconutWaterProcessingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automated Coconut Water Processing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automated Coconut Water Processing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/plants/beverages/beverage-heroes/hero_coconut_water.webp')` }} />
        <div className="rcp-hero__content">
          ...
          <h1 className="rcp-hero__title">
            Fully Automated Coconut Water Processing Plant
          </h1>
          <p className="rcp-hero__subtitle">
            Start Your Own Fully Automated Coconut Water Processing Plant Business with Salvin Industries' Automatic Turnkey Plant
          </p>
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Coconut Water <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>
                If you want to start a business in the processing industry, <strong>Salvin Industries</strong> is here to help you. We design, manufacture, and set up the complete <strong>Fully Automated Coconut Water Processing Plant</strong> for you. Instead of buying different machines from different places, we provide a complete "Turnkey Solution". This means we give you the entire factory setup from start to finish.
              </p>
              <p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Coconut Water Processing Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Coconut Water Plant?</h2>
            <p>
          ...
          <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
            ...
            <div className="rcp-seo-content__body">
              <div className="rcp-seo-content__block">
                <h3>Why Start a Fully Automated Coconut Water Processing Plant Business?</h3>
                <p>The demand for high-quality, hygienically processed products is growing rapidly in both domestic and international markets. By setting up an automated Fully Automated Coconut Water Processing Plant, you can produce large quantities safely. This is a highly profitable business with huge demand, as modern consumers prioritize branded, untouched-by-hand products.</p>
              </div>
