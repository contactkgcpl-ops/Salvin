...
const PROCESS_STEPS = [
  ...
  {
    "id": 4,
    "title": "Hooping & Pressing"
  },
  {
    "id": 5,
    "title": "Cooling & Chilling"
  },
  {
    "id": 6,
    "title": "Cutting"
...
const FAQS = [
  ...
  {
    "question": "How do you ensure soft paneer?",
    "answer": "By precisely controlling the coagulation temperature and the concentration of the coagulant (citric acid), we achieve the perfect moisture retention for soft paneer."
  }
];
...
const GALLERY_IMAGES = [
  {
    "src": "/turnkey-brochures/images/paneer-gallery/1.jpg",
    "caption": "Raw Milk Reception & Filtration"
  },
  {
    "src": "/turnkey-brochures/images/paneer-gallery/2.jpg",
    "caption": "Milk Standardization & Pasteurization"
  },
  {
    "src": "/turnkey-brochures/images/paneer-gallery/3.jpg",
    "caption": "Paneer Coagulation Vat"
  },
  {
    "src": "/turnkey-brochures/images/paneer-gallery/4.jpg",
    "caption": "Paneer Pressing & Dewatering"
  },
  {
    "src": "/turnkey-brochures/images/paneer-gallery/5.jpg",
    "caption": "Paneer Chilling & Cooling Tank"
  },
  {
    "src": "/turnkey-brochures/images/paneer-gallery/6.jpg",
    "caption": "Cutting & Vacuum Packing"
  }
]

export default function PaneerProcessingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automated Paneer Processing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automated Paneer Processing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/dairy-heroes/paneer.png')` }} />
        <div className="rcp-hero__content">
          ...
          <h1 className="rcp-hero__title">
            Fully Automated Paneer Processing Plant
          </h1>
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Paneer <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Start a highly successful business with our <strong>Fully Automated Paneer Processing Plant</strong>. Processed food products are a daily essential in every household, ensuring continuous, high-volume market demand all year round.</p>
      ...
      <section className="rcp-section rcp-seo-content" id="seo-guide" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title" dangerouslySetInnerHTML={{ __html: `A Simple Guide to <span class='rcp-accent'>Paneer Packaging</span>` }} />
          <p className="rcp-section-subtitle">Understanding the packaging process, accuracy, and market impact.</p>
          <div className="rcp-seo-content__body">
            <div className="rcp-seo-content__block">
              <h3>Why Start a Paneer Business?</h3>
              <p>Paneer is the heart of Indian and South Asian cooking. The demand for branded, high-quality, and hygienically packed blended spices and food products is skyrocketing. By manufacturing a perfectly balanced and highly aromatic Paneer, you can build a highly profitable and recurring FMCG business.</p>
            </div>
            
            <div className="rcp-seo-content__block">
              <h3>How Does the Paneer Processing Work?</h3>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Paneer Processing Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Paneer Plant?</h2>
            <p>
