...
const MACHINERY_LIST = [
  {
    ...
    image: "/assets/plants/cosmetics/body-wash-gallery/1_plant_overview.png"
  },
  {
    ...
    image: "/assets/plants/cosmetics/body-wash-gallery/2_storage_tanks.png"
  },
  {
    ...
    image: "/assets/plants/cosmetics/body-wash-gallery/3_mixing_vessel.png"
  },
  {
    ...
    image: "/assets/plants/cosmetics/body-wash-gallery/4_mixing_vessel_trolley.jpg"
  },
  {
    ...
    image: "/assets/plants/cosmetics/body-wash-gallery/5_mixing_vessel_pallet.png"
  },
  {
    ...
    image: "/assets/plants/cosmetics/body-wash-gallery/6_filling_machine.png"
  }
]
...
const GALLERY_IMAGES = [
  { id: 1, src: '/assets/plants/cosmetics/body-wash-gallery/1_plant_overview.png', caption: 'Multi-Level Mixing & Processing Plant', alt: 'Multi-Level Mixing & Processing Plant' },
  { id: 2, src: '/assets/plants/cosmetics/body-wash-gallery/2_storage_tanks.png', caption: 'Intermediate Storage Vessel Bank', alt: 'Intermediate Storage Vessel Bank' },
  { id: 3, src: '/assets/plants/cosmetics/body-wash-gallery/3_mixing_vessel.png', caption: 'Jacketed Mixing Vessel', alt: 'Jacketed Mixing Vessel' },
  { id: 4, src: '/assets/plants/cosmetics/body-wash-gallery/4_mixing_vessel_trolley.jpg', caption: 'Mobile Mixing Skid with Pump', alt: 'Mobile Mixing Skid with Pump' },
  { id: 5, src: '/assets/plants/cosmetics/body-wash-gallery/5_mixing_vessel_pallet.png', caption: 'Platform-Mounted Blending Unit', alt: 'Platform-Mounted Blending Unit' },
  { id: 6, src: '/assets/plants/cosmetics/body-wash-gallery/6_filling_machine.png', caption: 'Monoblock Rotary Filling & Capping', alt: 'Monoblock Rotary Filling & Capping' }
]
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/plants/cosmetics/cosmetic/body_wash_hero.png')`, backgroundColor: '#333' }} />
        ...
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <div className="rcp-overview__grid">
            ...
            <div className="rcp-overview__image rcp-overview__image--photo">
              <img src="/assets/plants/cosmetics/body-wash-gallery/1_plant_overview.png" alt="Plant Overview" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
