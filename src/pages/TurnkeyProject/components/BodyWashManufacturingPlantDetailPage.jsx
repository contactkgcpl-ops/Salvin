...
const MACHINERY_LIST = [
  {
    name: "Multi-Level Mixing & Processing Plant",
    desc: "Comprehensive multi-level processing plant with integrated mixing vessels and stairs for efficient batch production.",
    image: "/turnkey-brochures/images/body-wash-gallery/1_plant_overview.png"
  },
  {
    name: "Intermediate Storage Vessel Bank",
    desc: "A series of stainless steel storage tanks mounted on a raised platform for holding large volumes of finished product.",
    image: "/turnkey-brochures/images/body-wash-gallery/2_storage_tanks.png"
  },
  {
    name: "Jacketed Mixing Vessel",
    desc: "High-grade SS316 jacketed mixing vessel equipped with a top-mounted agitator and integrated control panel.",
    image: "/turnkey-brochures/images/body-wash-gallery/3_mixing_vessel.png"
  },
  {
    name: "Mobile Mixing Skid with Pump",
    desc: "Versatile mixing vessel mounted on a trolley base with a high-capacity transfer pump for mobility and flexibility.",
    image: "/turnkey-brochures/images/body-wash-gallery/4_mixing_vessel_trolley.jpg"
  },
  {
    name: "Platform-Mounted Blending Unit",
    desc: "Robust blending vessel situated on an accessible platform, providing easy operation and maintenance.",
    image: "/turnkey-brochures/images/body-wash-gallery/5_mixing_vessel_pallet.png"
  },
  {
    name: "Monoblock Rotary Filling & Capping",
    desc: "Automated monoblock machine combining precision rotary filling and capping in a single, compact footprint.",
    image: "/turnkey-brochures/images/body-wash-gallery/6_filling_machine.png"
  }
]
...
const GALLERY_IMAGES = [
  { id: 1, src: '/turnkey-brochures/images/body-wash-gallery/1_plant_overview.png', caption: 'Multi-Level Mixing & Processing Plant', alt: 'Multi-Level Mixing & Processing Plant' },
  { id: 2, src: '/turnkey-brochures/images/body-wash-gallery/2_storage_tanks.png', caption: 'Intermediate Storage Vessel Bank', alt: 'Intermediate Storage Vessel Bank' },
  { id: 3, src: '/turnkey-brochures/images/body-wash-gallery/3_mixing_vessel.png', caption: 'Jacketed Mixing Vessel', alt: 'Jacketed Mixing Vessel' },
  { id: 4, src: '/turnkey-brochures/images/body-wash-gallery/4_mixing_vessel_trolley.jpg', caption: 'Mobile Mixing Skid with Pump', alt: 'Mobile Mixing Skid with Pump' },
  { id: 5, src: '/turnkey-brochures/images/body-wash-gallery/5_mixing_vessel_pallet.png', caption: 'Platform-Mounted Blending Unit', alt: 'Platform-Mounted Blending Unit' },
  { id: 6, src: '/turnkey-brochures/images/body-wash-gallery/6_filling_machine.png', caption: 'Monoblock Rotary Filling & Capping', alt: 'Monoblock Rotary Filling & Capping' }
]

export default function BodyWashManufacturingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Body Wash Manufacturing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Body Wash Manufacturing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/cosmetic/body_wash_hero.png')`, backgroundColor: '#333' }} />
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Body Wash <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Capitalize on the global market with our <strong>Body Wash Manufacturing Plant</strong>. We deliver cutting-edge technology for processing Body Wash, ensuring high yield and premium quality.</p>
              <p>The manufacturing process is meticulously designed to handle the specific requirements of Body Wash production. From raw material intake to the final packaged product, every step is optimized for hygiene, speed, and consistency.</p>
            ...
            <div className="rcp-overview__image rcp-overview__image--photo">
              <img src="/turnkey-brochures/images/body-wash-gallery/1_plant_overview.png" alt="Plant Overview" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Body Wash Manufacturing Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="BodyWashManufacturingPlantDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Body Wash Plant?</h2>
            <p>
