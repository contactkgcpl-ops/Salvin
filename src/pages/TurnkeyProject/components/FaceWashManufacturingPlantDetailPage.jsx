...
const GALLERY_IMAGES = [
  { id: 0, src: '/assets/plants/cosmetics/cosmetic/face_wash_plant_0.webp', alt: 'Mixing & Heating Tanks' },
  { id: 1, src: '/assets/plants/cosmetics/cosmetic/face_wash_plant_1.webp', alt: 'Vacuum Emulsifying Mixer' },
  { id: 2, src: '/assets/plants/cosmetics/cosmetic/face_wash_plant_2.webp', alt: 'Homogenizer and Cooling Mixing Tank' },
  { id: 3, src: '/assets/plants/cosmetics/cosmetic/face_wash_plant_3.webp', alt: 'Intermediate Storage Tank' },
  { id: 4, src: '/assets/plants/cosmetics/cosmetic/face_wash_plant_4.webp', alt: 'Automatic Tube Filling & Sealing Machine' },
  { id: 5, src: '/assets/plants/cosmetics/cosmetic/face_wash_plant_5.webp', alt: 'Packing & Dispatch System' }
]
...
export default function FaceWashManufacturingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Face Wash Manufacturing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Face Wash Manufacturing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/plants/cosmetics/cosmetic/face_wash_hero.webp')`, backgroundColor: '#333' }} />
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Face Wash <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Capitalize on the global market with our <strong>Face Wash Manufacturing Plant</strong>. We deliver cutting-edge technology for processing Face Wash, ensuring high yield and premium quality.</p>
              <p>The manufacturing process is meticulously designed to handle the specific requirements of Face Wash production. From raw material intake to the final packaged product, every step is optimized for hygiene, speed, and consistency.</p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Face Wash Manufacturing Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="FaceWashManufacturingPlantDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Face Wash Plant?</h2>
            <p>
