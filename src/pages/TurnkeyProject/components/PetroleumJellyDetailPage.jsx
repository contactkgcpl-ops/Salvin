...
export default function PetroleumJellyDetailPage() {
  ...
  return (
    <div className="pjp-page">
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <section className="pjp-section pjp-why-salvin" id="why-salvin" data-animate>
        <div className={`pjp-container pjp-animate ${isVisible['why-salvin'] ? 'pjp-animate--in' : ''}`}>
          <div className="pjp-section-badge">Our Advantage</div>
          <h2 className="pjp-section-title">Why Choose <span className="pjp-accent">SALVIN</span></h2>
          <div className="pjp-why-salvin__grid">
            {/* Card 1 — Turnkey Solutions */}
            <div className="pjp-why-salvin__card">
              <div className="pjp-why-salvin__icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M2 20h20M4 20V10l8-7 8 7v10M10 20v-6h4v6" />
                </svg>
              </div>
              <div>
                <p className="pjp-why-salvin__title">Turnkey Solutions</p>
                <p className="pjp-why-salvin__desc">End-to-end processing solutions from design and manufacturing to installation and commissioning.</p>
              </div>
            </div>
            {/* Card 2 — GMP Design */}
            <div className="pjp-why-salvin__card">
              ...
              <div>
                <p className="pjp-why-salvin__title">Pharma Grade Design</p>
                <p className="pjp-why-salvin__desc">SS316L contact parts with hygienic construction for pharmaceutical-safe processing.</p>
              </div>
            </div>
            {/* Card 3 — Precision Heating */}
            <div className="pjp-why-salvin__card">
              <div className="pjp-why-salvin__icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div>
                <p className="pjp-why-salvin__title">Precision Heating</p>
                <p className="pjp-why-salvin__desc">Jacketed lines and melters ensure precise temperature control to prevent wax crystallization.</p>
              </div>
            </div>
            ...
            <div className="pjp-why-salvin__card">
              ...
              <div>
                <p className="pjp-why-salvin__title">Low Maintenance</p>
                <p className="pjp-why-salvin__desc">Robust industrial construction ensuring long service life and minimal maintenance.</p>
              </div>
            </div>
            ...
            <div className="pjp-why-salvin__card">
              ...
              <div>
                <p className="pjp-why-salvin__title">Automation Ready</p>
                <p className="pjp-why-salvin__desc">PLC-based automation and intelligent controls for consistent production.</p>
              </div>
            </div>
            ...
            <div className="pjp-why-salvin__card">
              ...
              <div>
                <p className="pjp-why-salvin__title">After Sales Support</p>
                <p className="pjp-why-salvin__desc">Dedicated technical support, spare parts assistance and service guidance.</p>
              </div>
            </div>
          </div>
        </div>
