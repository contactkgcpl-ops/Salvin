...
const MACHINERY_LIST = [
  {
    ...
    image: "/assets/plants/cosmetics/cosmetic/body_lotion_plant_1.webp"
  },
  {
    ...
    image: "/assets/plants/cosmetics/cosmetic/body_lotion_plant_2.webp"
  },
  {
    name: "High Shear Mixer / Homogenizer",
    desc: "High shear mixer ensuring a perfectly smooth and stable emulsion for body lotions.",
    image: "/assets/plants/cosmetics/cosmetic/body_lotion_plant_3.webp"
  },
  {
    ...
    image: "/assets/plants/cosmetics/cosmetic/body_lotion_plant_4.webp"
  },
  {
    ...
    image: "/assets/plants/cosmetics/cosmetic/body_lotion_plant_5.webp"
  },
  {
    name: "Labeling & Packaging Machine",
    desc: "Automated labeling and shrink sleeve packaging machine for final retail presentation.",
    image: "/assets/plants/cosmetics/cosmetic/body_lotion_plant_6.webp"
  }
]
...
const GALLERY_IMAGES = [
  { id: 1, src: '/assets/plants/cosmetics/cosmetic/body_lotion_plant_1.webp', alt: 'Raw Material Weighing & Dosing System' },
  { id: 2, src: '/assets/plants/cosmetics/cosmetic/body_lotion_plant_2.webp', alt: 'Vacuum Emulsifying Mixing Vessel' },
  { id: 3, src: '/assets/plants/cosmetics/cosmetic/body_lotion_plant_3.webp', alt: 'Homogenizer / High Shear Mixer' },
  { id: 4, src: '/assets/plants/cosmetics/cosmetic/body_lotion_plant_4.webp', alt: 'Storage Holding Tank' },
  { id: 5, src: '/assets/plants/cosmetics/cosmetic/body_lotion_plant_5.webp', alt: 'Automatic Bottle Filling & Capping Machine' },
  { id: 6, src: '/assets/plants/cosmetics/cosmetic/body_lotion_plant_6.webp', alt: 'Labeling & Packaging Machine' }
]
...
export default function BodyLotionManufacturingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Body Lotion Manufacturing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Body Lotion Manufacturing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/assets/plants/cosmetics/cosmetic/body_lotion_hero.webp')`, backgroundColor: '#333' }} />
        <div className="rcp-hero__content">
          ...
          <h1 className="rcp-hero__title">
            Body Lotion Manufacturing Plant
          </h1>
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Body Lotion <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Capitalize on the global market with our <strong>Body Lotion Manufacturing Plant</strong>. We deliver cutting-edge technology for processing Body Lotion, ensuring high yield and premium quality.</p>
              <p>The manufacturing process is meticulously designed to handle the specific requirements of Body Lotion production. From raw material intake to the final packaged product, every step is optimized for hygiene, speed, and consistency.</p>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Body Lotion Manufacturing Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="BodyLotionManufacturingPlantDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Body Lotion Plant?</h2>
            <p>
