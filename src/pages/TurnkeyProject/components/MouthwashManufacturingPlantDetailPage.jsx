...
const MACHINERY_LIST = [
  {
    name: "Conical Mixing Hopper with Load Cells",
    desc: "Stainless steel conical mixing hopper mounted on load cells for precise ingredient weighing and batch control.",
    image: "/turnkey-brochures/images/mouthwash-gallery/1_mixing_hopper.png"
  },
  {
    name: "Compact Filtration Skid",
    desc: "Space-saving filtration skid featuring multi-stage filter housings and a pneumatic diaphragm pump for efficient transfer.",
    image: "/turnkey-brochures/images/mouthwash-gallery/2_filtration_skid_small.png"
  },
  {
    name: "Medium Capacity Filtration System",
    desc: "Comprehensive filtration system equipped with a high-pressure pump to ensure crystal-clear mouthwash.",
    image: "/turnkey-brochures/images/mouthwash-gallery/3_filtration_skid_medium.png"
  },
  {
    name: "Industrial Multi-Stage Filtration Skid",
    desc: "Large-scale industrial filtration skid with multiple vertical housings designed for continuous, high-volume production.",
    image: "/turnkey-brochures/images/mouthwash-gallery/4_filtration_skid_large.jpg"
  },
  {
    name: "Automatic Rotary Capping Machine",
    desc: "Fully enclosed rotary capping machine providing high-speed and secure sealing for mouthwash bottles.",
    image: "/turnkey-brochures/images/mouthwash-gallery/5_bottling_machine_1.jpg"
  },
  {
    name: "Integrated Bottling & Filling Line",
    desc: "Complete automatic bottling line featuring inline filling, rotary capping, and conveying for seamless packaging.",
    image: "/turnkey-brochures/images/mouthwash-gallery/6_bottling_machine_2.png"
  }
]
...
const GALLERY_IMAGES = [
  { id: 1, src: '/turnkey-brochures/images/mouthwash-gallery/1_mixing_hopper.png', caption: 'Conical Mixing Hopper with Load Cells', alt: 'Conical Mixing Hopper with Load Cells' },
  { id: 2, src: '/turnkey-brochures/images/mouthwash-gallery/2_filtration_skid_small.png', caption: 'Compact Filtration Skid', alt: 'Compact Filtration Skid' },
  { id: 3, src: '/turnkey-brochures/images/mouthwash-gallery/3_filtration_skid_medium.png', caption: 'Medium Capacity Filtration System', alt: 'Medium Capacity Filtration System' },
  { id: 4, src: '/turnkey-brochures/images/mouthwash-gallery/4_filtration_skid_large.jpg', caption: 'Industrial Multi-Stage Filtration Skid', alt: 'Industrial Multi-Stage Filtration Skid' },
  { id: 5, src: '/turnkey-brochures/images/mouthwash-gallery/5_bottling_machine_1.jpg', caption: 'Automatic Rotary Capping Machine', alt: 'Automatic Rotary Capping Machine' },
  { id: 6, src: '/turnkey-brochures/images/mouthwash-gallery/6_bottling_machine_2.png', caption: 'Integrated Bottling & Filling Line', alt: 'Integrated Bottling & Filling Line' }
]

export default function MouthwashManufacturingPlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Mouthwash Manufacturing Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Mouthwash Manufacturing Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/cosmetic/mouthwash_hero.png')`, backgroundColor: '#333' }} />
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Mouthwash <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Capitalize on the global market with our <strong>Mouthwash Manufacturing Plant</strong>. We deliver cutting-edge technology for processing Mouthwash, ensuring high yield and premium quality.</p>
              <p>The manufacturing process is meticulously designed to handle the specific requirements of Mouthwash production. From raw material intake to the final packaged product, every step is optimized for hygiene, speed, and consistency.</p>
            ...
            <div className="rcp-overview__image rcp-overview__image--photo">
              <img src="/turnkey-brochures/images/cosmetic/mouthwash_hero.png" alt="Plant Overview" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Mouthwash Manufacturing Plant.</p>
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <WhyChooseSalvin prefix="rcp" isVisible={isVisible['why-salvin']} projectKey="MouthwashManufacturingPlantDetailPage" />
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Mouthwash Plant?</h2>
            <p>
      ...
      <section className="rcp-section rcp-seo-content" id="seo-guide" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">A Simple Guide to <span className="rcp-accent">Mouthwash Processing</span></h2>
          <p className="rcp-section-subtitle">Understanding the processing workflow, accuracy, and market impact.</p>
          <div className="rcp-seo-content__body">
            <div className="rcp-seo-content__block">
              <h3>Why Start a Mouthwash Processing Business?</h3>
            ...
            <div className="rcp-seo-content__block">
              <h3>How Does the Mouthwash Processing Work?</h3>
