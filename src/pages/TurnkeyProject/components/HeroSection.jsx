...
import HeroIMG from "../../../assets/Hero_home.jpg";
function HeroSection() {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "linear-gradient(90deg, rgba(8,37,77,0.84) 0%, rgba(8,37,77,0.74) 40%, rgba(8,37,77,0.45) 100%), {HeroIMG}",
    ...
    >
      <div className="mx-auto flex min-h-[72vh] w-full min-w-0 max-w-7xl items-center px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="max-w-3xl text-white">
          ...
          <h1 className="text-balance text-3xl font-extrabold leading-tight sm:text-4xl md:text-5xl lg:text-6xl">Building Turnkey Industrial Systems For A Smarter Manufacturing Future</h1>
