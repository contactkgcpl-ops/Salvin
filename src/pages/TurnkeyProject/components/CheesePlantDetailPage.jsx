...
const PROCESS_STEPS = [
  ...
  {
    "id": 3,
    "title": "Renneting & Coagulation"
  },
  {
    "id": 4,
    "title": "Curd Cutting & Cooking"
  },
  {
    "id": 5,
    "title": "Whey Separation"
  },
  {
    "id": 6,
    "title": "Pressing / Stretching"
  },
  {
    "id": 7,
    "title": "Brining & Aging"
...
const FAQS = [
  ...
  {
    "question": "Can we make both Cheddar and Mozzarella?",
    "answer": "Yes, our modular plants can be equipped with add-ons like a cooker-stretcher to produce both hard cheeses and stretchy pasta filata (Mozzarella) cheeses."
  }
];
...
const GALLERY_IMAGES = [
  {
    "src": "/turnkey-brochures/images/cheese-gallery/1.jpg",
    "caption": "Raw Milk Reception & Clarifier"
  },
  {
    "src": "/turnkey-brochures/images/cheese-gallery/2.jpg",
    "caption": "Milk Pasteurization Unit"
  },
  {
    "src": "/turnkey-brochures/images/cheese-gallery/3.jpg",
    "caption": "Cheese Vat & Coagulation"
  },
  {
    "src": "/turnkey-brochures/images/cheese-gallery/4.jpg",
    "caption": "Curd Cutting & Whey Draining"
  },
  {
    "src": "/turnkey-brochures/images/cheese-gallery/5.jpg",
    "caption": "Cheese Brining & Ripening"
  },
  {
    "src": "/turnkey-brochures/images/cheese-gallery/6.jpg",
    "caption": "Automatic Vacuum Packing"
  }
]

export default function CheesePlantDetailPage() {
  ...
  useEffect(() => {
    document.title = 'Fully Automatic Cheese Plant | Salvin Industries'
    const metaDesc = document.querySelector('meta[name="description"]')
    if (metaDesc) metaDesc.setAttribute('content', 'Complete turnkey solution for Fully Automatic Cheese Plant. High efficiency, robust design, and automatic processing.')
  }, [])
  ...
  return (
    <div className="rcp-page">
      ...
      <section className="rcp-hero">
        ...
        <div className="rcp-hero__bg" style={{ backgroundImage: `url('/turnkey-brochures/images/dairy-heroes/cheese.png')` }} />
      ...
      <section className="rcp-section rcp-overview" id="overview" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['overview'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title">Commercial Cheese <span className="rcp-accent">Manufacturing Plant</span></h2>
          <div className="rcp-overview__grid">
            <div className="rcp-overview__text">
              <p>Start a highly successful business with our <strong>Fully Automatic Cheese Plant</strong>. Processed food products are a daily essential in every household, ensuring continuous, high-volume market demand all year round.</p>
      ...
      <section className="rcp-section rcp-seo-content" id="seo-guide" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['seo-guide'] ? 'rcp-animate--in' : ''}`}>
          ...
          <h2 className="rcp-section-title" dangerouslySetInnerHTML={{ __html: `A Simple Guide to <span class='rcp-accent'>Cheese Packaging</span>` }} />
          <p className="rcp-section-subtitle">Understanding the packaging process, accuracy, and market impact.</p>
          <div className="rcp-seo-content__body">
            <div className="rcp-seo-content__block">
              <h3>Why Start a Cheese Business?</h3>
              <p>Cheese is the heart of Indian and South Asian cooking. The demand for branded, high-quality, and hygienically packed blended spices and food products is skyrocketing. By manufacturing a perfectly balanced and highly aromatic Cheese, you can build a highly profitable and recurring FMCG business.</p>
            </div>
            
            <div className="rcp-seo-content__block">
              <h3>How Does the Cheese Processing Work?</h3>
      ...
      <section className="rcp-section rcp-faq-section" id="faq" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['faq'] ? 'rcp-animate--in' : ''}`}>
          ...
          <p className="rcp-section-subtitle">Everything you need to know about our Cheese Plant Plant.</p>
      ...
      <section className="rcp-section rcp-cta" id="enquiry" data-animate>
        <div className={`rcp-container rcp-animate ${isVisible['enquiry'] ? 'rcp-animate--in' : ''}`}>
          <div className="rcp-cta__box">
            <h2>Ready to Build Your Cheese Plant?</h2>
            <p>
