...
export default function PastaNoodlesDetailPage() {
  ...
  return (
    <div className="pnp-page">
      ...
      {/* ═══ WHY CHOOSE SALVIN ═══ */}
      <section className="pnp-section pnp-why-salvin" id="why-salvin" data-animate>
        <div className={`pnp-container pnp-animate ${isVisible['why-salvin'] ? 'pnp-animate--in' : ''}`}>
          <div className="pnp-section-badge">Our Advantage</div>
          <h2 className="pnp-section-title">Why Choose <span className="pnp-accent">SALVIN</span></h2>
          <div className="pnp-why-salvin__grid">
            {/* Card 1 — Turnkey Solutions */}
            <div className="pnp-why-salvin__card">
              <div className="pnp-why-salvin__icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M2 20h20M4 20V10l8-7 8 7v10M10 20v-6h4v6" />
                </svg>
              </div>
              <div>
                <p className="pnp-why-salvin__title">Turnkey Solutions</p>
                <p className="pnp-why-salvin__desc">End-to-end processing solutions from design and manufacturing to installation and commissioning.</p>
              </div>
            </div>
            ...
            <div className="pnp-why-salvin__card">
              ...
              <div>
                <p className="pnp-why-salvin__title">Food Grade Design</p>
                <p className="pnp-why-salvin__desc">SS304/SS316 contact parts with hygienic construction for food-safe processing.</p>
              </div>
            </div>
            ...
            <div className="pnp-why-salvin__card">
              ...
              <div>
                <p className="pnp-why-salvin__title">Energy Efficient</p>
                <p className="pnp-why-salvin__desc">Optimized systems designed to reduce power consumption and improve productivity.</p>
              </div>
            </div>
            ...
            <div className="pnp-why-salvin__card">
              ...
              <div>
                <p className="pnp-why-salvin__title">Low Maintenance</p>
                <p className="pnp-why-salvin__desc">Robust industrial construction ensuring long service life and minimal maintenance.</p>
              </div>
            </div>
            ...
            <div className="pnp-why-salvin__card">
              ...
              <div>
                <p className="pnp-why-salvin__title">Automation Ready</p>
                <p className="pnp-why-salvin__desc">PLC-based automation and intelligent controls for consistent production.</p>
              </div>
            </div>
            ...
            <div className="pnp-why-salvin__card">
              ...
              <div>
                <p className="pnp-why-salvin__title">After Sales Support</p>
                <p className="pnp-why-salvin__desc">Dedicated technical support, spare parts assistance and service guidance.</p>
              </div>
            </div>
          </div>
        </div>
