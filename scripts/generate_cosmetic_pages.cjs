...
const plants = [
    { title: 'Face Wash Manufacturing Plant', short: 'Face Wash', comp: 'FaceWashManufacturingPlantDetailPage', slug: 'face-wash-manufacturing-plant' },
    { title: 'Shampoo Manufacturing Plant', short: 'Shampoo', comp: 'ShampooManufacturingPlantDetailPage', slug: 'shampoo-manufacturing-plant' },
    { title: 'Hair Oil Manufacturing Plant', short: 'Hair Oil', comp: 'HairOilManufacturingPlantDetailPage', slug: 'hair-oil-manufacturing-plant' },
    { title: 'Body Lotion Manufacturing Plant', short: 'Body Lotion', comp: 'BodyLotionManufacturingPlantDetailPage', slug: 'body-lotion-manufacturing-plant' },
    { title: 'Hand Wash Manufacturing Plant', short: 'Hand Wash', comp: 'HandWashManufacturingPlantDetailPage', slug: 'hand-wash-manufacturing-plant' }
];
