...
const plants = [
    { title: 'Fully Automated Aloe Vera Juice Processing Plant', short: 'Aloe Vera Juice', comp: 'AloeVeraJuiceProcessingPlantDetailPage' },
    { title: 'Fully Automatic Biscuit Plant', short: 'Biscuit', comp: 'BiscuitPlantDetailPage' },
    { title: 'Fully Automatic Cookie Plant', short: 'Cookie', comp: 'CookiePlantDetailPage' },
    { title: 'Fully Automated Bread Plant', short: 'Bread', comp: 'BreadPlantDetailPage' },
    { title: 'Cake Plant', short: 'Cake', comp: 'CakePlantDetailPage' },
    { title: 'Fully Automatic Wafer Plant', short: 'Wafer', comp: 'WaferPlantDetailPage' },
    { title: 'Fully Automatic Chocolate Processing Plant', short: 'Chocolate', comp: 'ChocolateProcessingPlantDetailPage' },
    { title: 'Fully Automatic Toffee Plant', short: 'Toffee', comp: 'ToffeePlantDetailPage' }
];
