...
const p = {
    file: 'HairConditionerManufacturingDetailPage.jsx',
    title: 'Hair Conditioner Manufacturing Plant',
    img: 'hair_conditioner_flowchart.jpg',
    desc: "Start Your Own Hair Conditioner Manufacturing Plant Business with Salvin Industries' Automatic Turnkey Plant",
    metaDesc: 'Complete turnkey Hair Conditioner Manufacturing Plant by Salvin Industries. Fully automated processing lines for hair conditioner products.',
    processSteps: [
      { id: 1, title: 'Raw Material' },
      { id: 2, title: 'Ingredient Weighing & Dosing' },
      { id: 3, title: 'Batch Mixing' },
      { id: 4, title: 'Syrup Preparation' },
      { id: 5, title: 'Hair Conditioner Forming' },
...
const svgs = [
  '<svg className="hcm-process-card__icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z" /><path d="m3.3 7 8.7 5 8.7-5" /><path d="M12 22V12" /></svg>',
  '<svg className="hcm-process-card__icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 3H2l8 9.46V19l4 2v-8.54L22 3z" /></svg>',
  '<svg className="hcm-process-card__icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="4" /><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41" /></svg>',
  ...
  '<svg className="hcm-process-card__icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 3v18M3 12h18M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18z" /><path d="M7.5 7.5l9 9M7.5 16.5l9-9" /></svg>',
  '<svg className="hcm-process-card__icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M19 22H5a2 2 0 0 1-2-2V4h18v16a2 2 0 0 1-2 2z" /><path d="M12 4v10" /><path d="M9 11l3 3 3-3" /></svg>',
  '<svg className="hcm-process-card__icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 3H2l8 9.46V19l4 2v-8.54L22 3z" /></svg>'
];
  ...
  return (
    <div className="hcm-page">
      ...
      <section className="hcm-hero">
        ...
        <div className="hcm-hero__bg" style={{ backgroundImage: \`url('/turnkey-brochures/images/cosmetic/${p.img}')\` }} />
        <div className="hcm-hero__content">
          <span className="hcm-hero__badge">
            <span className="hcm-hero__badge-dot" />
            TURNKEY SOLUTION
          </span>
          <h1 className="hcm-hero__title">${p.title}</h1>
          <p className="hcm-hero__subtitle">${p.desc}</p>
        ...
        <div className={\`hcm-container hcm-animate \${isVisible['overview'] ? 'hcm-animate--in' : ''}\`}>
          ...
          <div className="hcm-overview__grid">
            ...
            <div className="hcm-overview__image hcm-overview__image--photo" style={{ backgroundColor: '#fff', padding: '10px', display: 'flex', justifyContent: 'center' }}>
              <img src="/turnkey-brochures/images/hair-conditioner-gallery/2_vacuum_mixer.jpg" alt="${p.title}" loading="lazy" style={{ objectFit: 'contain', width: '100%', height: '100%', maxHeight: '600px', borderRadius: '8px' }} />
            </div>
          </div>
        </div>
      </section>
...
fs.writeFileSync(path.join(__dirname, 'src/pages/TurnkeyProject/components/HairConditionerManufacturingDetailPage.jsx'), content);
console.log("Completely rebuilt HairConditionerManufacturingDetailPage.jsx!");
